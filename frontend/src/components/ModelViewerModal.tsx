import { useState, useEffect, useId, useRef, useMemo, type ReactNode } from 'react';
import { useTranslation } from 'react-i18next';
import { useQuery } from '@tanstack/react-query';
import { ExternalLink, Box, Code2, Cog, Loader2, Layers, Check, Maximize2, Minimize2, ChevronDown } from 'lucide-react';
...
export function ModelViewerModal({ archiveId, libraryFileId, title, fileType, archivePlateIndex, onSliceWithBamDude, onClose }: ModelViewerModalProps) {
  ...
  return (
    <Modal
      ...
      panelClassName={isFullscreen ? '' : 'h-[80vh]'}
