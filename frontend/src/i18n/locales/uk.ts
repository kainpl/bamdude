export default {
  ...
  queue: {
    ...
    groupBadge: 'група {{current}} з {{total}} · {{units}} одиниць',
    groupedQueued: 'Додано {{queued}} у {{groups}} групах',
    groupedQueuedWithAsks: 'Додано {{queued}} у {{groups}} групах; {{asked}} потребували відповіді',
