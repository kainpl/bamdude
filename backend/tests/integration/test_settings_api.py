...
class TestSettingsAPI:
    ...
    async def test_unset_temp_alarm_reads_back_as_null(self, async_client: AsyncClient, db_session):
        """upstream #2905: ams_temp_alarm is nullable, and settings storage stringifies
    ...
    async def test_temp_alarm_survives_a_set_then_clear_round_trip(self, async_client: AsyncClient):
        """The path the settings page actually takes, end to end (upstream #2905).
    ...
    async def test_mqtt_defaults(self, async_client: AsyncClient):
        ...
        assert result["mqtt_topic_prefix"] == "bamdude"
