...
export function AddTelegramChatModal({ chat, providerId, onClose }: AddTelegramChatModalProps) {
  ...
  const EVENT_LABEL_KEYS: Record<string, string> = {
    ...
    scheduled_drying_started: 'notifications.scheduledDryingStarted',
    scheduled_drying_completed: 'notifications.scheduledDryingCompleted',
    scheduled_drying_failed: 'notifications.scheduledDryingFailed',
