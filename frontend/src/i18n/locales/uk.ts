export default {
  ...
  filamentRouting: {
    ...
    feasibility: {
      ...
      queueAnyway: "Усе одно в чергу — чекатиме потрібного філаменту",
      queueInsteadOfPrinting: "Додати до черги — чекатиме потрібного філаменту",
      confirmTitle: "Усе одно поставити в чергу?",
      confirmBody: "Завдання буде додано й чекатиме в черзі, доки в принтера не буде потрібного.",
      confirmBodyPrint: "Завдання піде в чергу цього принтера й чекатиме там. Негайний друк натомість було б скасовано. Файл, завантажений із «надрукувати й видалити», залишиться в бібліотеці: завдання в черзі — це вже не той негайний друк, який мав його прибрати.",
      reason: {
