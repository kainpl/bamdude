export default {
  ...
  stats: {
    title: 'Панель',
    subtitle: 'Перетягуйте віджети для зміни порядку. Натисніть іконку ока, щоб приховати.',
    overview: 'Огляд',
  ...
  projects: {
    ...
    noProjectsFiltered: 'Немає {{status}} проєктів',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Видимий як "Bambuddy" у виявленні слайсера',
  ...
  bugReport: {
    ...
    emailPrivacy: 'Якщо вказано, ваш email буде включено у згорнуту секцію GitHub issue для подальшого зв\'язку.',
    ...
    dataIncluded: 'Включено:',
    dataIncludedList: 'Версія додатку, ОС, архітектура, версія Python, статистика бази даних (лише підрахунки), моделі принтерів, кількість сопел, версії прошивок, стан підключення, стан інтеграцій (Spoolman, MQTT, HA), нечутливі налаштування, кількість мережевих інтерфейсів, деталі Docker, версії залежностей.',
    ...
    submit: 'Надіслати',
    startLogging: 'Почати налагоджувальне логування',
    stepEnableLogging: 'Налагоджувальне логування увімкнено',
    ...
    stoppingLogs: 'Збір журналів та надсилання...',
    submitting: 'Надсилання звіту...',
