...
Cycle `applied=0.2.3b2` → `next=0.2.3b3` (15 ported / 0 missing / 1 deferred / 6 N/A). Full audit: `temp/bambuddy-changes-audit-v0.2.3b2-v0.2.3b3.md`.
...
- **Skipped (deferred to 0.3.3)**: Scheduled Local Backups (2A) — large feature, separate release cycle
