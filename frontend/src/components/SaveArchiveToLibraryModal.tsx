...
import { Check, FileBox, FolderInput, FolderOpen, Loader2 } from 'lucide-react';
...
export function SaveArchiveToLibraryModal({ archiveId, archiveName, isOpen, onClose }: Props) {
  ...
  return (
    <Modal
      ...
      size="md"
      header={
        <h3 id={headingId} className="text-sm font-semibold text-white flex items-center gap-2 min-w-0">
