...
const createMockPlug = (overrides: Partial<SmartPlug> = {}): SmartPlug => ({
  ...
  mqtt_energy_total_topic: null,
  mqtt_energy_total_path: null,
  mqtt_energy_total_multiplier: 1.0,
  // MQTT command fields
  mqtt_command_topic: null,
  mqtt_command_on: null,
  mqtt_command_off: null,
  // REST driver — unused by a tasmota plug, but the type has no partial form
  rest_on_url: null,
  rest_on_body: null,
  rest_off_url: null,
  rest_off_body: null,
  ...
  rest_energy_total_path: null,
  rest_energy_total_multiplier: 1.0,
  zigbee_ieee: null,
  controls_printer_power: false,
  auto_off_after_drying: false,
  off_delay_after_drying_minutes: 0,
