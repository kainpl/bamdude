              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-green-300 space-y-1 list-disc list-inside">
                    ...
                    <li>{t('settings.ldap.feature3') || 'LDAP groups are mapped to BamDude groups on login'}</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-2">
              <div>
                ...
                <p className="text-xs text-bambu-gray mt-0.5">
                  {t('settings.ldap.autoProvisionHint') || 'Automatically create a BamDude account on first LDAP login'}
                </p>
              </div>
              <button
            ...
            <div>
              ...
              />
              <p className="text-xs text-bambu-gray mt-1">
                {t('settings.ldap.groupMappingHint') || 'Map LDAP group DNs to BamDude groups. Available groups: '}{groups.map(g => g.name).join(', ')}
              </p>
            </div>

            {/* Default Group (fallback when user has no mapped groups) */}
            <div>
              <label className="block text-sm font-medium text-bambu-gray mb-2">
