export default {
  ...
  settings: {
    ...
    preheatFilamentTargetsHint: 'BamDude обирає найвищу цільову температуру серед філаментів, які використовує друк, — котушка, що просто стоїть в AMS, не враховується; друки лише з PLA дають 0 і автоматично пропускають фазу камери.',
