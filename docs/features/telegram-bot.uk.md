...
- **Знімки камери** -- Перегляд живих зображень з камери
...
1. Перейдіть до **Параметри** > **Сповіщення**
...
3. Перейдіть до **Параметри** > **Сповіщення** > **Чати Telegram** у BamDude
...
## :material-image: Знімки камери

Запитуйте знімки камери безпосередньо в Telegram:
...
1. Натисніть **Друк з бібліотеки** в головному меню
...
2. BamDude автоматично визначить модель принтера
3. Введіть код доступу
...
| Сповіщення | Дії |
|-----------|-----|
| **Друк завершено** | Очистити стіл |
| **Друк невдалий** | Очистити стіл |
| **Обслуговування необхідне** | Позначити виконаним |
| **Прогрес друку** | Пауза / Зупинка |
