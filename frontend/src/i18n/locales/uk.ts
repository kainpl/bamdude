export default {
  ...
  printers: {
    ...
    bedJog: {
      ...
      notHomedMessage: 'Вісь Z не була відгомлена після останнього друку. Спочатку відгомліть Z для безпечного позиціонування, або рухайте так — програмні обмежувачі буде вимкнено.',
      homeZ: 'Відгомити Z',
      moveAnyway: 'Рухати все одно',
      homingStarted: 'Відгомлення осі Z…',
    },
    // Permissions
    permission: {
