/**
 * Tests for the copy-spool button in InventoryPage (B.copy-filament).
 *
 ...
 *
 * Adapted from upstream Bambuddy ``6a130c09`` (#1246).
 */
...
describe('InventoryPage — copy button', () => {
  ...
  it('opens SpoolFormModal in "Copy Spool" mode when the copy button in the cards view is clicked', async () => {
    ...
    // Switch to cards view. The toggle button's accessible name is the
    // visible "Cards" text from t('inventory.cards') (en locale).
