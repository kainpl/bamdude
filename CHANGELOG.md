...
Second beta milestone of the 0.4.0 cycle. Bundles every "(post-b1)" section below (printer card, archives UI, queue/dispatch follow-up, projects, library, authentication, macros, etc.) into a single image: `ghcr.io/kainpl/bamdude:0.4.0b2` / `kainpl/bamdude:0.4.0b2`. Still pre-release — pin the exact tag, `:latest` keeps pointing at 0.3.2 until the stable cut.
