export default {
  ...
  copyQueue: {
    ...
    // Показано разом із зображенням, але вибрати не можна: m173 зберіг власні
    // байти цього завдання, а копія — це звичайне додавання, якому потрібен
    // оригінал, щоб прочитати його знову.
    ...
    readsOriginalHint: 'Копія — це нове додавання: оригінальний файл читається знову і зберігається для кожної копії.',
    copy: 'Копіювати',
  },
