...
/**
 * MakerWorld glyph (the "B" cube logo). Drawn from MakerWorld's own SVG —
 * the brand isn't in Simple Icons, so we ship the path directly. Sized 24×24
 * with ``currentColor`` so it inherits the surrounding text colour.
 */
export function MakerWorldIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
