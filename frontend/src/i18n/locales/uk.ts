export default {
  ...
  fileManager: {
    ...
    bulkQueue: {
      ...
      toAuto: 'Авто-черга',
      modeEach: 'на кожен',
      modeSpread: 'розкидати',
      spreadHint: 'Розкидання прибиває кожен друк до принтера зараз, по колу. Авто-черга вирішує пізніше, коли принтер справді звільниться.',
      notSliced: 'не нарізаний',
      plates_one: '{{count}} плита',
      plates_few: '{{count}} плити',
      plates_many: '{{count}} плит',
      plates_other: '{{count}} плит',
      submit_one: 'Додати {{count}} друк',
      submit_few: 'Додати {{count}} друки',
      submit_many: 'Додати {{count}} друків',
      submit_other: 'Додати {{count}} друків',
      queued_one: '{{count}} друк у черзі',
      queued_few: '{{count}} друки у черзі',
      queued_many: '{{count}} друків у черзі',
      queued_other: '{{count}} друків у черзі',
    },
    allTypes: 'Усі типи',
