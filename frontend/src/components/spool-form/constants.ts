...
export const KNOWN_VARIANTS = [
  ...
  // base material + subtype here instead of needing a separate ``-CF`` /
  // ``-GF`` Material entry (upstream Bambuddy #1345).
  'CF', 'GF',
...
// Local storage keys
export const RECENT_COLORS_KEY = 'bamdude-recent-colors';
