...
class Permission(StrEnum):
    ...
    INVENTORY_FORECAST_READ = "inventory:forecast_read"  # View stock-forecasting / Logistics panel
    INVENTORY_FORECAST_WRITE = "inventory:forecast_write"  # Modify SKU settings + shopping list
    ...
    NOTIFICATIONS_INBOX = "notifications:inbox"  # Read and manage one's own in-app inbox (spec: notification-center)
...
DEFAULT_GROUPS = {
    ...
    "Operators": {
        ...
        "permissions": [
            ...
            Permission.NOTIFICATIONS_INBOX.value,
