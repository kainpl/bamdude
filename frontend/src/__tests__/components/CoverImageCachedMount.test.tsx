/**
 * The printer-card thumbnail has to survive an image the browser already has.
 *
 ...
 * cache -- no network request at all, which is why the Network
 * panel shows nothing at all while the thumbnail sits on the placeholder.
 *
 ...
 * why it reproduces every time for some people and not at all for others.
 *
