export default {
  ...
  fileManager: {
    ...
    linkFolderDescription: 'Прив\'язати "{{name}}" до одного або кількох проєктів для швидкого доступу.',
  ...
  orders: {
    ...
    lines: {
      ...
      moveUp: 'Підняти',
      moveDown: 'Опустити',
      printPlate: 'Надрукувати пластину…',
    ...
    printPlate: {
      ...
      print: 'Друкувати',
      noPlates: 'У цього виробу ще немає пластин — спочатку прив’яжіть файл.',
      materials: 'Матеріали:',
    },
    procurement: {
