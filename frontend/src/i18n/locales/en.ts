export default {
  ...
  settings: {
    ...
    archiveCleanup: {
      ...
      daysUnit: 'days',
      daysHint:
        'A design is eligible when its newest print across all archive copies is older than this. Minimum 1 day. Daily sweep runs at server-local midnight.',
      lastRun: 'Last run',
  ...
  archivePurge: {
    ...
    previewFailed: 'Could not preview the purge.',
    previewSummary: '{{count}} archives · {{size}} would move to trash',
    andMore: '…and {{count}} more',
    warning: 'Archives in trash still count against storage until the retention window expires. Empty the Trash afterwards to free disk immediately.',
    confirmCta: 'Move {{count}} to trash',
    purging: 'Moving to trash…',
    toast: {
      success: 'Moved {{count}} archive(s) to trash.',
  ...
  fileManager: {
    ...
    linkFile: 'Link File',
    linkFileDescription: 'Link "{{name}}" to a project so it shows up in that project\'s print plan.',
