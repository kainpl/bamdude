export default {
  ...
  libraryDedupe: {
    headerButton: 'Дублікати',
    headerTooltip: 'Знайти файли, вміст яких уже є в бібліотеці',
    title: 'Дублікати файлів',
    nothingToDo: 'Дублікатів немає — вміст кожного файла в бібліотеці унікальний.',
    summary_one: '{{count}} файл має вміст, який уже є в іншому файлі.',
    summary_few: '{{count}} файли мають вміст, який уже є в інших файлах — груп: {{groups}}.',
    summary_many: '{{count}} файлів мають вміст, який уже є в інших файлах — груп: {{groups}}.',
    summary_other: '{{count}} файлів мають вміст, який уже є в інших файлах — груп: {{groups}}.',
    whichSurvives: 'Лишається та копія, на яку щось посилається — історія друків, черга, проєкт. Якщо посилаються на всі, лишається найстаріша.',
    reversible: 'Решта йде в корзину, тож нічого не знищується і будь-що можна відновити.',
    confirm: 'Перенести дублікати в корзину',
    toast: {
      success_one: '{{count}} дублікат перенесено в корзину',
      success_few: '{{count}} дублікати перенесено в корзину',
      success_many: '{{count}} дублікатів перенесено в корзину',
      success_other: '{{count}} дублікатів перенесено в корзину',
      failed: 'Не вдалося прибрати дублікати',
    },
  },
  libraryPurge: {
