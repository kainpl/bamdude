export default {
  ...
  labelSheets: {
    ...
    builtin: 'вбудований',
    builtinHint: 'Вбудований аркуш. Редагувати не можна — автоматизація, яка рік друкує на цьому папері, не має раптом знайти сітку зсунутою. Зробіть копію — вона ваша.',
  ...
  labelEditor: {
    ...
    builtinHint:
      'Вбудований дизайн. Його ім’я — це те, що приймає API друку, тож змінити його не можна — автоматизація, яка рік друкує цю етикетку, не має раптом почати друкувати інше. Зробіть копію — її редагувати можна.',
