        ...
        <CardContent className="space-y-4">
          ...
          <div className="py-3 border-t border-bambu-dark-tertiary">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                onClick={() => handleModeChange('file_manager')}
                disabled={pendingAction === 'mode'}
                className={`p-3 rounded-lg border text-left transition-colors ${
                  localMode === 'file_manager'
                    ? 'border-bambu-green bg-bambu-green/10'
                    : 'border-bambu-dark-tertiary hover:border-bambu-gray'
                }`}
              >
                <div className="text-white font-medium">{t('virtualPrinter.mode.fileManager')}</div>
                <div className="text-xs text-bambu-gray">{t('virtualPrinter.mode.fileManagerDesc')}</div>
              </button>
              <button
          ...
          <CardContent className="py-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm">
                ...
                <a
                  href="https://wiki.bamdude.cool/features/virtual-printer/"
                  target="_blank"
