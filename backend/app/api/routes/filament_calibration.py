...
@router.post("/calibration/sessions/{session_id}/cancel", status_code=204, response_model=None)
...
# this. Applies to every 204 route in a module with the future-annotations
# import — pinned by test_204_routes_declare_response_model.
@router.delete("/filament-calibrations/{cali_id}", status_code=204, response_model=None)
