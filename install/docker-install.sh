...
#
# Usage:
#   Interactive:  curl -fsSL https://raw.githubusercontent.com/kainpl/bambuddy-he/main/install/docker-install.sh -o docker-install.sh && chmod +x docker-install.sh && ./docker-install.sh
...
download_compose_file() {
    ...
    if [[ "$BUILD_FROM_SOURCE" == "true" ]]; then
        ...
        curl -fsSL -o docker-compose.yml \
            https://raw.githubusercontent.com/kainpl/bambuddy-he/main/docker-compose.yml
    fi
