export default {
  ...
  inventory: {
    ...
    midPrintReplacement: {
      ...
      optin: 'Цей друк був на паузі на шарі {{layer}}, і я тоді фізично замінив котушку — розділити списання на тому шарі',
    },
  ...
  forecast: {
    ...
    receiveFailed: 'Не вдалося оприбуткувати замовлення - нічого не змінено. Спробуй ще раз.',
