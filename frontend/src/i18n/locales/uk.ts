export default {
  ...
  settings: {
    ...
    slicerBundlesRemoved: {
      title: 'Бандли слайсера (видалено)',
      description: 'Імпорт Printer Preset Bundle (.bbscfg) видалено. Експорт бандла з BambuStudio містить лише кастомні пресети користувача, тому імпорт ніколи не давав стандартних процесів / філаментів, і слайсинг відкочувався на вбудовані налаштування.',
      alternatives: 'Використовуй імпорт окремого пресета для власних, або синхронізацію через Bambu Cloud / Orca Cloud. Стандартні пресети приходять із сайдкара слайсера автоматично.',
      lookupOrder: 'Порядок пошуку пресетів під час слайсингу: 1) Імпортовані (локальні), 2) Orca Cloud, 3) Bambu Cloud, 4) Стандартні (запасні з сайдкара).',
    },
