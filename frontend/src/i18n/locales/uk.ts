export default {
  ...
  inventory: {
    ...
    resetUsageTooltip: 'Обнулити лічильник використаних грамів цієї котушки',
    resetUsageConfirm: 'Обнулити лічильник використаних грамів цієї котушки? Майбутні друки знову почнуть відлік з нуля. Сама котушка, розрахунок залишку та ваші налаштування залишаться незмінними.',
    resetAllUsage: 'Скинути використання всіх котушок',
    resetAllUsageTooltip: 'Обнулити лічильник використаних грамів для кожної активної котушки',
    resetAllUsageConfirm: 'Обнулити лічильник використаних грамів для всіх {{count}} активних котушок? Це очистить статистику «Загально використано», майбутні друки знову зчитуватимуться з нуля. Котушки та залишки залишаться без змін.',
    usageReset: 'Використання котушки обнулено',
