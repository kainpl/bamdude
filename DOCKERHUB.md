...
- **Notifications** — Telegram, Discord, Email, Pushover, ntfy, Signal CLI API (self-hosted via signal-cli-rest-api — `docker-compose.signal.yml` runs one next to BamDude) with per-chat settings, quiet hours, actionable buttons
