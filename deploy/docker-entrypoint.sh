...
#     unwritable by uid 1000 inside the container — see upstream
#     Bambuddy #1211 / #668 for the virtual_printer bind-mount case the
#     shipped compose template historically shipped uncommented.
#
