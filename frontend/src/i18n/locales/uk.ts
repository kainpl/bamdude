export default {
  ...
  archives: {
    ...
    modal: {
      ...
      deleteConfirmQueueWarning: 'Робіт у черзі з цього архіву: {{count}}.',
  ...
  queueSpool: {
    state: {
      ready: {
        ...
        tipWithSize: 'Файл збережено для черги ({{size}}) — завдання друкує власну копію й більше не потребує оригіналу.',
      },
      preparing: {
      ...
      legacy: {
        ...
        tip: 'Додано в чергу, коли BamDude ще не тримав власних копій. Завдання читає оригінальний файл, тож тримайте його доступним до друку.',
      },
      broken: {
        label: 'Копію втрачено',
        tip: 'Збережена копія зникла або пошкоджена, тож завдання не надрукується. Повторіть його, щоб зберегти файл знову, або приберіть із черги.',
      },
    },
    ...
    // Те, що оператор питає насправді: завдання створене чи ні?
    failure: {
      nothingQueued: 'До черги нічого не додано. {{reason}}',
      partial: 'Додано до черги: {{success}} з {{total}}. Ще {{failed}} не додано. {{reason}}',
    ...
    deleteNote: {
      ...
      selfContained: 'Робіт із власною збереженою копією: {{count}}. Вони лишаються в черзі й надрукуються.',
      needsOriginal: 'Робіт, які досі читають ці файли: {{count}}. Їх буде скасовано разом із ними.',
