export default {
  ...
  printers: {
    ...
    cleanupAfterPrint: 'Limpeza após impressão',
    mqttConnectionTimeout: 'Timeout de conexão MQTT',
    status: {
    ...
    modal: {
      ...
      cleanupAfterPrintLabel: 'Excluir arquivos do cartão SD após a impressão (desmarque para mover para o cache)',
      mqttConnectionTimeoutLabel: 'Timeout de conexão MQTT',
      mqttConnectionTimeoutHint: 'segundos (0 = desabilitado)',
  ...
  archives: {
    ...
    page: {
      collection: {
        all: 'Todos',
        recent: 'Últimas 24 horas',
        thisWeek: 'Esta semana',
        thisMonth: 'Este mês',
        favorites: 'Favoritos',
        failed: 'Impressões falhadas',
      ...
      slicedGcode: 'Fatiado (GCODE)',
      sourceOnly: 'Apenas fonte',
      allTags: 'Todas as tags',
      favorites: 'Favoritos',
      hideFailed: 'Ocultar falhados',
      colors: 'Cores:',
      reset: 'Redefinir',
      clear: 'Limpar',
      matchAnyColor: 'Corresponder a QUALQUER cor selecionada',
      matchAllColors: 'Corresponder a TODAS as cores selecionadas',
      archivesAutoCreated: 'Os arquivos são criados automaticamente quando as impressões são concluídas',
      unknownPrinter: 'Desconhecido',
      slicedFor: 'Fatiado para {{model}}',
    ...
    calendar: {
      totalPrints: 'Impressões (30 dias)',
      successful: 'Bem-sucedidas',
      failed: 'Falhadas',
      noPrints: 'Sem impressões neste dia',
      selectDay: 'Selecione um dia para ver as impressões',
    },
    list: {
      name: 'Nome',
      printer: 'Impressora',
  ...
  support: {
    ...
    description: 'Ative o log de depuração para capturar informações detalhadas e baixe um pacote de suporte para compartilhar.',
    debugLogging: 'Log de depuração',
    debugLoggingActive: 'Registro de depuração ativo',
    debugLoggingEnabled: 'Capturando logs detalhados',
    debugLoggingDisabled: 'Nível de log normal',
    enableDebug: 'Ativar',
    disableDebug: 'Desativar',
    manageLogs: 'Gerenciar',
    supportBundle: 'Pacote de suporte',
    supportBundleDescription: 'Baixar informações do sistema e logs como ZIP',
    enableDebugFirst: 'Ative o log de depuração primeiro',
    instructions: 'Para relatar um problema:',
    step1: 'Ativar o log de depuração',
    step2: 'Reproduzir o problema',
    step3: 'Baixar o pacote de suporte',
    step4: 'Anexar o arquivo ZIP ao seu relatório',
    privacyTitle: 'O que contém o pacote de suporte?',
    collected: 'Coletado:',
    collectItem1: 'Versão do app e modo de depuração',
    collectItem2: 'SO, arquitetura, versão Python',
    collectItem3: 'Estatísticas do banco de dados (apenas contagens)',
    collectItem4: 'Modelos de impressora e número de bicos',
    collectItem5: 'Configurações não sensíveis (temas, formatos)',
    collectItem6: 'Logs de depuração (sanitizados)',
    ...
    notItem1: 'Nomes e números de série das impressoras',
    notItem2: 'Códigos de acesso e senhas',
    notItem3: 'Endereços de e-mail',
    notItem4: 'Chaves de API e tokens',
    notItem5: 'URLs de webhook',
    notItem6: 'Seu hostname ou nome de usuário',
    notItem7: 'Endereços IP',
    privacyNote: 'Endereços de e-mail nos logs são substituídos por [EMAIL], nomes de impressoras por [PRINTER], números de série por [SERIAL] e endereços IP por [IP].',
  },
  ...
  system: {
    ...
    subtitle: 'Monitorar recursos do sistema e estatísticas do banco de dados',
    failedToLoad: 'Falha ao carregar informações do sistema',
    version: 'Versão',
    uptime: 'Tempo de atividade',
    hostname: 'Hostname',
    application: 'Aplicação',
    database: 'Banco de dados',
    connectedPrinters: 'Impressoras conectadas',
    storage: 'Armazenamento',
    memory: 'Memória',
    cpu: 'CPU',
    systemDetails: 'Detalhes do sistema',
    totalArchives: 'Total de arquivos',
    ...
    totalPrintTime: 'Tempo total de impressão',
    totalFilament: 'Filamento total utilizado',
    ofTotal: 'de {{total}} impressoras conectadas',
    ...
    fileManagerStorage: 'Gerenciador de arquivos',
    ...
    python: 'Python',
    bootTime: 'Hora de inicialização',
    platform: 'Plataforma',
    networkInfo: 'Info de rede',
    logs: 'Logs',
    debugMode: 'Modo de depuração',
    enableDebug: 'Ativar log de depuração',
    disableDebug: 'Desativar log de depuração',
  ...
  virtualPrinter: {
    ...
    mode: {
      ...
      fileManager: 'Gerenciador de arquivos',
      fileManagerDesc: 'Salvar diretamente no gerenciador de arquivos',
      proxy: 'Proxy',
  ...
  logViewer: {
    ...
    subtitle: 'Visualizar e filtrar logs da aplicação',
    liveStreaming: 'Streaming ao vivo - {{count}} entradas',
    live: 'Ao vivo',
    stop: 'Parar',
    start: 'Iniciar',
    clear: 'Limpar',
    autoScroll: 'Rolagem automática',
    searchPlaceholder: 'Pesquisar por mensagem ou nome do logger...',
    all: 'Todos',
    noLogEntries: 'Nenhuma entrada de log encontrada',
    logFileEmpty: 'O arquivo de log pode estar vazio ou limpo',
    autoRefreshing: 'Atualizando automaticamente a cada 2 segundos',
    clickStartHint: 'Clique em Iniciar para ativar o streaming de log ao vivo',
  },
