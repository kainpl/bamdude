export default {
  ...
  stock: {
    ...
    empty: 'На полиці поки нічого немає.',
    part: 'Деталь',
    perUnit: 'На виріб',
    balance: 'На полиці',
    movements: 'Рухи',
    ...
    adjust: {
      ...
      noParts: 'Цей виріб не рахує жодної деталі, тож залишку в нього немає.',
    },
    bank: {
      action: 'Списати надлишок у залишок',
      none: 'У жодного рядка цього замовлення немає надлишку.',
