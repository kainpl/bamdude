export default {
  ...
  filamentRouting: {
    ...
    feasibility: {
      ...
      reason: {
        ...
        fts_external_unsupported: "External filament cannot be used while Filament Track Switch is connected.",
        fts_state_unavailable: "Waiting for the printer to confirm whether Filament Track Switch is still connected.",
        tpu_left_firmware_unavailable: "Waiting for the firmware TPU capability of the left nozzle.",
        tpu_left_firmware_unsupported: "Current firmware does not support TPU on the left nozzle.",
  ...
  printers: {
    ...
    camWall: {
      ...
      snap: 'Snap',
      off: 'Off',
      startLive: 'Watch {{printer}} live',
      stopLive: 'Stop live view for {{printer}}',
      openPrinterCard: 'Open printer card',
    ...
    bedJog: {
      ...
      titleToolhead: 'Move toolhead (Z)',
      bed: 'Bed',
      z: 'Z',
      step: 'Step (mm)',
      up: 'Move plate up',
      down: 'Move plate down',
      upToolhead: 'Move toolhead up',
      downToolhead: 'Move toolhead down',
    ...
    modal: {
      ...
      amsCompat: {
        title: 'AMS Backup compatibility emulation',
        warning: 'The printer will be told a deliberately different profile for manually assigned spools. The real spool in BamDude does not change; RFID spools are never touched.',
        normalizeColor: 'Advertise one canonical colour to the AMS',
        canonicalColorHint: 'Opaque colour every eligible slot is reported as',
        genericBaseMaterial: 'Advertise the Generic family of the base material (PLA, PETG, ABS, ASA, TPU)',
        applyHint: 'Changing this does not rewrite slots already configured. Use “Apply to assigned slots” in the AMS Backup dialog on the printer card.',
      },
      swapMode: 'Swap Mode',
    ...
    drying: {
      ...
      blockedPower: 'Connect the AMS power adapter to enable drying',
      blockedRetract: 'Retract the filament at the AMS outlet to start drying',
      blockedOther: "The AMS can't start drying right now",
      ...
      delayHours: 'Start in (hours)',
      startAt: 'Start at',
      repeatAt: 'Start time',
      notLaterThan: 'Not later than (optional)',
      farmTime: 'Farm time ({{tz}})',
      everyDay: 'Every day',
      weekdayShort: {
        mon: 'Mon',
        tue: 'Tue',
      ...
      scheduled: 'Drying scheduled',
      scheduleFailed: 'Failed to schedule drying',
      runAt: 'at {{time}}',
      runWhenFree: 'when the printer is free',
      runRunning: 'drying on schedule',
      waiting: 'waiting: {{reason}}',
      runDidNotHappen: 'did not happen: {{reason}}',
      ...
      reason: {
        ...
        ams_not_found: 'the AMS is not found',
        blocked_power: 'the AMS needs its power adapter',
        blocked_filament_at_outlet: 'filament is at the AMS outlet',
        blocked_other: 'the AMS cannot start drying',
        interrupted: 'a print interrupted it',
        window_passed: 'its start window passed',
  ...
  settings: {
    ...
    trackingModeSwitch: {
      title: 'Switch filament tracking?',
      toSpoolman: 'Filament will be tracked in Spoolman from now on.',
      toBuiltIn: 'Filament will be tracked in the built-in inventory from now on.',
      checking: 'Checking what this changes…',
      assignments_one: '{{count}} slot assignment will be removed — spools are assigned to AMS slots anew in the new mode.',
      assignments_other: '{{count}} slot assignments will be removed — spools are assigned to AMS slots anew in the new mode.',
      noAssignments: 'No slot assignments will be removed.',
      printing: 'Printing now: {{printers}}. Filament these prints use will not be charged to either inventory.',
      confirm: 'Switch',
    },
    ...
    otherCameras: {
      title: 'Other cameras',
      description: 'Cameras that do not belong to a printer — a room, a shelf, a dryer. They appear on the camera wall and on a button in their location’s header, and they never replace a printer’s own camera.',
      add: 'Add camera',
      added: 'Camera added',
      name: 'Name',
      namePlaceholder: 'Shelf by the window',
      type: 'Type',
      url: 'Camera URL',
      device: 'Device path',
      snapshotUrlHelp: 'Optional. A URL that returns ONE frame, used instead of reading past the live stream\u2019s warm-up frame when a snapshot is taken. Useful for go2rtc (/api/frame.jpeg) and IP cameras with their own snapshot endpoint. Leave blank to take frames from the stream above.',
      location: 'Location',
      enabled: 'Show on the wall',
      testOk: 'The camera answered with a frame',
      testFailed: 'No frame from this camera',
      deleteAria: 'Delete camera {{name}}',
      deleteTitle: 'Delete this camera?',
      deleteMessage: '“{{name}}” will stop appearing on the wall and in its location. Nothing else is affected.',
    },
    ...
    tempAlarmSeparateFromBand: 'Only the alarm threshold sends notifications — Good and Fair colour the display. Leave it empty to alarm at the fair threshold, as before. No alarm is sent while the AMS is drying or cooling down after it.',
    ...
    staggerConcurrentPerGroup: 'Default concurrent starts per group',
    staggerConcurrentPerGroupDescription: 'Default limit for printers heating within one group. An explicit group limit below can be higher or lower; choose it to suit your electrical capacity.',
    ...
    staggerGroupLimitHint: 'Empty inherits the default above; a number overrides it. With tags and locations enabled, each axis has its own limit and their intersection uses the lower one.',
    ...
    preheatFilamentTargetsHint: 'BamDude picks the highest target among the filaments the print uses — a spool that only sits in the AMS does not count. A print whose filaments all derive 0 — PLA, PETG, TPU, PVA — skips preheat entirely and starts immediately.',
    ...
    preheatTargetOverrideHelp: '0 heats the bed and runs the soak without the chamber. Leave it blank and a print whose filaments want no chamber skips preheat entirely.',
    ...
    cameraLightAutoDescription: 'Before any use of the camera — a photo in Telegram, a stream, the Camera Wall, a finish photo, the plate check — switch the chamber light on if it is off, and back off afterwards. A light that was already on is never touched, and only a light BamDude switched on is switched off. Off by default; each printer can say yes or no for itself in the External cameras list below.',
  ...
  camera: {
    ...
    diagnose: {
      ...
      summary: {
        ...
        worker_unavailable: 'The camera worker is unavailable. Camera-dependent checks may wait; check System status and server logs.',
        camera_busy: 'The camera is already owned by a live stream or Virtual Printer. Stop that session before probing it.',
  ...
  slicerSettings: {
    ...
    fromFileOverridesPresetHint: 'The file sets this to {{value}} where the preset you picked uses {{preset}}. Tick it only if the file should win.',
  ...
  slice: {
    ...
    designSettingsOverridesPreset: 'overrides preset',
    designSettingsOverridesPresetHint: "The layer height is what the process preset you picked is, so the file's value is offered but not pre-selected. Tick it only if the file should win over your pick.",
  ...
  orders: {
    ...
    card: {
      ...
      overdue: 'Overdue',
      covered: 'Covered',
      coverageSources: '{{printed}} printed · {{stock}} from stock',
    ...
    figures: {
      ordered: 'Ordered',
      printed: 'Printed',
      assemblyReady: 'Can assemble',
      remaining: 'Left to cover',
      time: 'Print time',
      grams: 'Filament, g',
      cost: 'Production cost',
      filamentCost: 'Filament',
      energyCost: 'Electricity',
      defective: 'Defective',
      otherPrints: 'Other prints: {{n}}',
      coverage: 'Covered',
      coverageSources: '{{printed}} printed · {{stock}} from stock',
      coverageHint: 'Printed kits and allocated stock; purchased components are counted separately.',
      printingPrints: 'Printing (prints)',
    ...
    filament: {
      ...
      short: 'short {{amount}}',
      shortAtLeast: 'short at least {{amount}}',
      atLeast: 'at least {{amount}}',
      weightUnknown: 'weight unknown',
      ...
      unattributedPrints_one: '{{count}} print with unknown filament',
      unattributedPrints_other: '{{count}} prints with unknown filament',
  ...
  system: {
    ...
    preview: {
      ...
      states: { ready: 'Available', starting: 'Starting', recovering: 'Restarting', unavailable: 'Unavailable' },
      reasons: {
        not_started: 'The preview runtime has not started.',
        starting: 'Waiting for the local preview service.',
        stopped: 'The preview runtime has stopped.',
        startup_failed: 'The local preview service could not start.',
        recovery_required: 'A previous broker runtime needs ownership checks before recovery.',
        broker_disconnected: 'The connection to the local preview broker was lost.',
        worker_restarting: 'The preview worker is restarting automatically.',
        circuit_open: 'Repeated worker failures; automatic restart is temporarily delayed.',
        ownership_uncertain: 'A preview process could not be confirmed stopped; restart is disabled.',
      },
      scope: 'Generates model previews. Printing and existing thumbnails are unaffected.',
      manualRecovery: 'Stop BamDude and verify that all preview processes have exited before following the recovery guide. Do not delete the runtime marker blindly.',
      checkLogs: 'If this persists, check the logs, installation dependencies, free disk space and access to the runtime directory.',
      error: 'Error type',
      directory: 'Runtime directory',
      guide: 'Preview troubleshooting and recovery',
    },
    cameraWorker: {
      title: 'Camera worker',
      states: { ready: 'Available', starting: 'Starting', recovering: 'Restarting', unavailable: 'Unavailable', stopped: 'Stopped' },
      scope: 'Camera capture is isolated. Unrelated printing and queues remain available; camera-dependent checks may wait.',
      reason: 'Failure type',
      nextRetry: 'Next retry',
      restarts: 'Restart attempts',
    },
    analysisWorker: {
      title: '3MF analysis worker',
      states: { ready: 'Available', unavailable: 'Unavailable' },
      scope: 'Calculates filament usage outside the server event loop. An outage pauses new projections; printing and queues continue.',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'BamDude is running in {{runtime}} with bridge networking. Printer discovery and the Virtual Printer need host networking - recreate the container with host network mode ("network_mode: host" in docker-compose, "--network=host" for Podman).',
        skip: 'Not running in a container - not applicable.',
        skip_unknown: 'BamDude is running in {{runtime}}, but its network mode could not be determined. If printer discovery or the Virtual Printer do not work, recreate the container with host networking.',
        skip_system_container: 'BamDude is running in a {{runtime}} system container, which sits on the LAN like a virtual machine - not applicable.',
      },
      subnet: {
  ...
  printModal: {
    ...
    ftsArrangementSaves: 'Recommended filament arrangement saves about {{time}}:',
    ftsArrangementMove: 'Filament {{filament}} → an AMS on IN-{{inlet}}',
    ftsSaveSeconds: '{{s}} s',
    ftsSaveMinutes: '{{m}} min {{s}} s',
  ...
  notifications: {
    ...
    missingSpoolAssignmentDescription: 'Notify when a print starts with trays that have no assigned spool, and when a finished print could not charge its filament to one',
    ...
    scheduledDryingStarted: 'Scheduled Drying Started',
    scheduledDryingStartedDescription: 'A drying you scheduled has started on an AMS',
    scheduledDryingCompleted: 'Scheduled Drying Finished',
    scheduledDryingCompletedDescription: 'A drying you scheduled has run its course',
    scheduledDryingFailed: 'Scheduled Drying Did Not Happen',
    scheduledDryingFailedDescription:
      'A drying you scheduled did not run — its window passed, the unit refused it, or it cannot dry',
    ...
    center: {
      title: 'Notifications',
      tabs: { inbox: 'Inbox', subscriptions: 'Subscriptions', email: 'Email' },
      ...
      inbox: {
        empty: 'Nothing here yet.',
        emptyHint: 'Events you subscribe to will show up here. Pick them on the Subscriptions tab.',
        ...
        markedRead: '{{count}} marked as read',
        clear: 'Clear',
        clearConfirmTitle: 'Clear inbox',
      ...
      subscriptions: {
        intro: 'Choose which events land in your inbox. By default you receive warnings and errors only.',
        usingDefaults: 'Using the defaults: warnings and errors',
        custom: 'Custom selection',
        reset: 'Reset to defaults',
        saveError: 'Failed to save subscriptions.'
      },
      events: {
        print_start: 'Print started',
        ...
        print_progress: 'Print progress milestones',
        print_missing_spool_assignment: 'Missing spool assignment (at print start, or filament not charged)',
        first_layer_complete: 'First layer complete',
        bed_cooled: 'Bed cooled down',
        printer_error: 'Printer error',
        printer_offline: 'Printer offline',
        ai_failure_detection: 'AI failure detection',
        plate_not_empty: 'Plate not cleared',
        maintenance_due: 'Maintenance due',
        filament_runout: 'Filament ran out',
        filament_low: 'Filament running low',
        filament_deficit: 'Not enough filament for the job',
        ...
        queue_job_waiting: 'Queue job waiting for you',
        queue_job_added: 'Queue job added',
        queue_job_started: 'Queue job started',
        queue_completed: 'Queue completed',
        printer_queue_completed: 'Printer queue completed',
        stock_break_alert: 'Stock ran out',
        stock_reorder_alert: 'Stock below reorder level',
        sensor_above_max: 'Sensor above maximum',
        sensor_below_min: 'Sensor below minimum',
        sensor_silent: 'Sensor went silent',
        sensor_back_in_range: 'Sensor back in range',
  ...
  failureDetection: {
    ...
    statusTitle: 'Status',
    serviceRunning: 'Detection active',
  ...
  forecast: {
    ...
    reservedIncomplete: 'Some active-order filament weights are unknown. “Reserved” and reorder dates include only the known part.',
    actions: 'Actions',
    // Rate tier badges
    trend: 'Trend',
    estimated: 'Est.',
