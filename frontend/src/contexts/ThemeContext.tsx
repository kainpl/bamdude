...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  // System preference detection — tracks the OS's prefers-color-scheme so the
  // 'system' mode resolves to the live OS setting (client display only; this
  // never touches server settings, so it doesn't cross the locale/settings
  // authority line).
  ...
  useEffect(() => {
    ...
    // Apply based on resolved mode (so 'system' follows the OS setting).
