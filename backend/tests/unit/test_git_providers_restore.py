...
def _github_commit(sha: str, message: str = "BamDude backup", date: str = "2026-07-01T10:00:00Z"):
    return {"sha": sha, "commit": {"message": message, "author": {"name": "BamDude", "date": date}}}
    ...
    async def test_returns_normalised_commits_newest_first(self):
        ...
        client.get = AsyncMock(
            return_value=_make_mock_response(
                200,
                [
                    _github_commit("aaa111", "BamDude backup - newest", "2026-07-02T10:00:00Z"),
                    _github_commit("bbb222", "BamDude backup - older", "2026-07-01T10:00:00Z"),
                ],
            )
        )
        ...
        assert result["commits"][0]["message"] == "BamDude backup - newest"
        assert result["commits"][0]["author"] == "BamDude"
...
class TestGetCommit:
    ...
    async def test_gitlab_reads_its_flattened_shape(self):
        ...
        assert result["commit"]["author"] == "BamDude"
