export default {
  ...
  setup: {
    ...
    toast: {
      authEnabledAdminCreated: 'Автентифікацію увімкнено та адміністратора створено',
      authEnabledExistingAdmins: 'Автентифікацію увімкнено з використанням існуючих адміністраторів',
      setupCompleted: 'Налаштування завершено',
      enterBothCredentials: "Введіть ім'я та пароль адміністратора, або залиште обидва поля порожніми для використання існуючих адміністраторів",
      passwordsDoNotMatch: 'Паролі не збігаються',
      passwordTooShort: 'Пароль повинен містити щонайменше 6 символів',
    },
  },
  ...
  spoolbuddy: {
    ...
    dashboard: {
      ...
      idleMessage: 'Поставте котушку на ваги для ідентифікації',
      nfcHint: 'NFC тег буде прочитано автоматично',
      device: 'Пристрій',
      ...
      selectSpool: "Виберіть котушку для прив'язки цього тегу:",
      noUntagged: 'Котушок без тегів не знайдено',
      tagDetected: 'Тег виявлено',
      noTag: 'Без тегу',
      tagId: 'Тег',
      grossWeight: 'Повна вага',
    ...
    ams: {
      ...
      connectAms: 'Підключіть AMS для перегляду слотів філаменту',
    ...
    settings: {
      ...
      readTagDiagnostic: 'Діагностика читання тегу',
      testNfc: 'Тест зчитувача',
      testScale: 'Тест точності',
      testReadTag: 'Прочитати тег',
      systemFieldsRequired: "URL бекенду обов'язковий.",
      // Display tab
      brightness: 'Яскравість',
      saved: 'Збережено',
      noBacklight: 'DSI підсвітку не виявлено. Керування яскравістю вимагає DSI дисплей.',
      screenBlank: 'Таймаут вимкнення екрану',
      screenBlankDesc: 'Екран вимикається після бездіяльності. Торкніться для пробудження.',
      ...
      calStep1: 'Зніміть усі предмети з ваг та натисніть Встановити нуль.',
      ...
      // Updates tab
      daemonVersion: 'Версія демона',
      currentVersion: 'Поточна',
      versionPending: 'Очікування демона...',
      checking: 'Перевірка...',
      checkUpdates: 'Перевірити оновлення',
      updateAvailable: 'Доступне оновлення',
      updateInstructions: 'Оновіть через SSH: запустіть скрипт встановлення SpoolBuddy.',
      upToDate: 'Актуальна версія',
      includeBeta: 'Включати бета-версії',
    },
    writeTag: {
      tabExisting: 'Існуюча котушка',
      tabNew: 'Нова котушка',
      tabReplace: 'Замінити тег',
      searchPlaceholder: 'Пошук за матеріалом, кольором, брендом...',
      noUntaggedSpools: 'Немає котушок без тегів',
      noTaggedSpools: 'Немає котушок з тегами',
      selectSpool: 'Виберіть котушку, потім покладіть чистий NTAG на зчитувач',
      ...
      queueFailed: 'Не вдалося поставити запис у чергу',
      tryAgain: 'Спробувати ще',
      cancel: 'Скасувати',
      replaceWarning: "Старий тег буде від'єднано. Новий тег замінить його.",
      ...
      creating: 'Створення...',
      spoolCreated: 'Котушку створено! Готовий до запису.',
