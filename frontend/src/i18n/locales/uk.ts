export default {
  ...
  filamentRouting: {
    ...
    advisoryUnavailable: "Частину принтерів не вдалося перевірити. Сумісність перевірена не повністю; відсутність результату не означає несумісності.",
    "feedPolicy": "Джерело філаменту",
    "feedAuto": "Автоматично: AMS або зовнішня котушка",
    "feedAms": "Лише AMS",
    "feedExternal": "Лише зовнішні котушки",
    "baseMaterialMatch": "Дозволити збіг за базовим матеріалом",
    "baseMaterialMatchDesc": "Увімкнено: шукати за матеріалом, який вказано у файлі — PETG, ABS — хоч який профіль з будь-якого боку. Вимкнено: потрібен той самий профіль скрізь, де його названо з обох боків.",
    ...
    "noPrinters": "У вибраній області ферми немає активних принтерів {{model}}. Тут немає кому призначити це завдання.",
    ...
    "unresolvedCounts": "Несумісні: {{incompatible}} · Не перевірені: {{unknown}}",
    "nextFileReview": "Налаштування каналів стосуються цього файлу. Для наступного файлу групи відкриється форма.",
    // Чи можна чесно натиснути кнопку друку. `reason` і `detail` дзеркалять
    // backend/app/data/filament_routing_uk.json один в один — жоден ендпоїнт не
    // віддає речення про конкретний принтер, обраний у цьому діалозі, тож
    // словник дзеркалиться, а не завантажується.
    feasibility: {
      blocked: "Нічим із вибраного не надрукувати цей плейт із тим, що зараз у лотках.",
      unknown: "Сумісність перевірена не повністю. Друк недоступний, доки не підтверджено повне призначення філаменту.",
      unknownDetail: "Сумісність перевірена не повністю. Остання перевірка: {{detail}}",
      queueAnyway: "Усе одно в чергу — чекати сумісності",
      queueInsteadOfPrinting: "Додати до черги замість друку — чекати сумісності",
      queueForFuture: "Зберегти в авточерзі на майбутнє",
      confirmTitle: "Усе одно поставити в чергу?",
      confirmBody: "Завдання чекатиме підтвердження сумісності. Може знадобитися зміна філаменту, налаштувань або обладнання. У черзі конкретного принтера воно може затримати наступні завдання, доки причину не усунуто або завдання не переміщено чи видалено.",
      confirmBodyFuture: "Завдання залишиться без призначення, доки у вибраній області не з’явиться активний принтер потрібної моделі. Збереження не робить його придатним до друку на поточній фермі.",
      confirmBodyPrint: "Друк зараз не почнеться. Завдання піде в чергу цього принтера й чекатиме підтвердження сумісності; воно може затримати наступні завдання, доки причину не усунуто або завдання не переміщено чи видалено. Файл із «надрукувати й видалити» залишиться в бібліотеці: постановка в чергу його не видаляє.",
      reason: {
        material_mismatch: "Немає сумісного джерела філаменту.",
        variant_mismatch: "Не збігається різновид філаменту.",
        color_mismatch: "Потрібний колір не завантажено.",
        nozzle_mismatch: "Не збігається діаметр або фізична прив’язка сопла.",
        fts_external_unsupported: "Зовнішній філамент не можна використовувати, коли підключено Filament Track Switch.",
        fts_state_unavailable: "Очікуємо, доки принтер підтвердить, чи Filament Track Switch досі підключено.",
        tpu_left_firmware_unavailable: "Очікуємо дані прошивки про підтримку TPU на лівому соплі.",
        tpu_left_firmware_unsupported: "Поточна прошивка не підтримує TPU на лівому соплі.",
        distinct_sources_required: "Кожному використаному каналу потрібне окреме сумісне джерело.",
        model_mismatch: "Модель принтера не відповідає нарізаному файлу.",
      },
      detail: {
        wantedAndLoaded: "Канал {{slot}} потребує {{wanted}}; у лотках: {{loaded}}.",
        wantedNothingLoaded: "Канал {{slot}} потребує {{wanted}}; лотки порожні.",
        wantedOnly: "Канал {{slot}} потребує {{wanted}}.",
      },
    },
},
  // Navigation
  ...
  printers: {
    ...
    amsBackup: {
      ...
      firmwareReported: 'Групи повідомлені прошивкою принтера.',
      firmwareEstimate: 'Цей принтер не повідомив групи резервування; їх оцінено за завантаженими слотами.',
    ...
    ams: {
      ...
      feedPrompt: 'Перемикач тракту філаменту може спрямувати цей слот у будь-який хотенд. Виберіть, у який подавати.',
      feedLeft: 'Ліве сопло',
      feedRight: 'Праве сопло',
      feedAlreadyLoaded: 'Уже завантажено',
      switchNotReady: 'Перемикач тракту філаменту ще не налаштовано. Призначте кожній AMS вхід на принтері й спробуйте ще раз.'
    },
    bedJog: {
      title: 'Перемістити стіл',
      titleToolhead: 'Перемістити голову (Z)',
      bed: 'Стіл',
      z: 'Z',
      step: 'Крок (мм)',
      up: 'Стіл вгору',
      down: 'Стіл вниз',
      upToolhead: 'Голова вгору',
      downToolhead: 'Голова вниз',
    ...
    modal: {
      ...
      amsCompat: {
        title: 'Емуляція сумісності AMS Backup',
        warning: 'Принтеру повідомлятиметься навмисно інший профіль для вручну призначених котушок. Реальна котушка в BamDude не змінюється; RFID-котушки не чіпаються ніколи.',
        normalizeColor: 'Оголошувати AMS один канонічний колір',
        canonicalColorHint: 'Непрозорий колір, під яким повідомляється кожен придатний слот',
        genericBaseMaterial: 'Оголошувати Generic-родину базового матеріалу (PLA, PETG, ABS, ASA, TPU)',
        applyHint: 'Зміна не переписує вже налаштовані слоти. Скористайтесь «Застосувати до призначених слотів» у діалозі AMS Backup на картці принтера.',
      },
      swapMode: 'Swap Mode',
    ...
    drying: {
      ...
      // Which dry_sf_reason blocks drying — the one the backend would name first.
      blockedPower: "Під'єднайте блок живлення AMS, щоб увімкнути сушіння",
      blockedRetract: 'Відведіть філамент з виходу AMS, щоб почати сушіння',
      blockedOther: 'AMS зараз не може почати сушіння',
      // Scheduled drying (upstream #2703 + recurring rules)
      when: 'Коли',
      mode: {
        now: 'Зараз',
        delay: 'Через…',
        at: 'О…',
        when_free: 'Щойно звільниться',
        repeat: 'Повторювати',
      },
      delayHours: 'Почати через (год)',
      startAt: 'Почати о',
      repeatAt: 'О котрій',
      notLaterThan: 'Не пізніше (необовʼязково)',
      farmTime: 'Час ферми ({{tz}})',
      everyDay: 'Щодня',
      weekdayShort: {
        mon: 'Пн',
        tue: 'Вт',
      ...
      scheduled: 'Сушку заплановано',
      scheduleFailed: 'Не вдалося запланувати сушку',
      runAt: 'о {{time}}',
      runWhenFree: 'щойно принтер звільниться',
      runRunning: 'сушить за розкладом',
      waiting: 'чекає: {{reason}}',
      runDidNotHappen: 'не відбулась: {{reason}}',
      cancelScheduled: 'Скасувати заплановану сушку',
      dismiss: 'Прибрати',
      ...
      reason: {
        ...
        already_drying: 'AMS уже сушить',
        ams_not_found: 'AMS не знайдено',
        blocked_power: 'AMS потрібен блок живлення',
        blocked_filament_at_outlet: 'філамент на виході AMS',
        blocked_other: 'AMS не може почати сушіння',
        interrupted: 'його перервав друк',
        window_passed: 'минуло вікно старту',
  ...
  archives: {
    no3mfBanner: {
      ftpsRefused: {
        title: 'Деякі нещодавні друки не вдалося заархівувати — принтер відмовив у файловому з\'єднанні',
        body: 'BamDude відкрив порт передачі файлів принтера (FTPS 990), а принтер відхилив з\'єднання, тож прочитати з нього нічого не вдалося. Ці друки заархівовано з назвою й часом, лише без мініатюри та метаданих слайсера. Це не налаштування слайсера і не щось, що ви змінили: найчастіше в цей момент файловий сервіс принтера використовувала інша програма — сторінка пристрою в слайсері чи інша інтеграція. BamDude питає знову, коли принтер перепідключається і коли друк завершується, а «Повторити завантаження 3MF» у меню архіву питає одразу; файл, що ще лежить на принтері, заповнить свій архів.',
        docsLink: 'Що означає ця помилка',
      },
      authRejected: {
        title: 'Деякі нещодавні друки не вдалося заархівувати — принтер відхилив код доступу',
        body: 'Принтер відмовив BamDude у вході для передачі файлів, тож прочитати з нього нічого не вдалося. Ці друки заархівовано лише з назвою й часом. Код доступу неправильний або змінився після перемикання режиму LAN чи режиму розробника. Скопіюйте його знову з екрана принтера в налаштування принтера в BamDude, а тоді скористайтеся «Повторити завантаження 3MF» у меню відповідних архівів.',
        docsLink: 'Як виправити код доступу',
      },
      unreachable: {
        title: 'Деякі нещодавні друки не вдалося заархівувати — файловий сервіс принтера не відповів',
        body: 'BamDude не зміг дістатися порту передачі файлів принтера (FTPS 990) — з\'єднання не вдалося або вичерпало час очікування, — тож прочитати з нього нічого не вдалося. Ці друки заархівовано лише з назвою й часом. Можливо, принтер був вимкнений чи поза мережею, або щось між BamDude і принтером (брандмауер, мережа Docker) блокує порт 990. BamDude питає знову, коли принтер перепідключається; «Повторити завантаження 3MF» у меню архіву питає одразу.',
        docsLink: 'Діагностика порту 990',
      },
      notFound: {
        title: 'Деякі нещодавні друки не вдалося заархівувати з мініатюрами',
        body: 'Принтер не зберіг нарізаний .gcode.3mf, тож BamDude не зміг отримати мініатюру чи метадані слайсера. Зазвичай це через те, що «Зберігати надіслані файли на зовнішньому носії» вимкнено в слайсері (вкладка Device у Bambu Studio / OrcaSlicer).',
    ...
    modal: {
      ...
      deleteConfirmQueueWarning: 'Робіт у черзі з цього архіву: {{count}}. Ті з них, що очікують і досі читають цей архів, буде скасовано разом із ним.',
  ...
  autoQueue: {
    ...
    rebalance: {
      ...
      skipped: {
        ...
        source_unreadable: 'Цільовий файл не читається — перевірте файл, його теку або спільний ресурс',
        source_copy_busy: 'Черга була зайнята збереженням файлів — наступний прохід перенесе, робити нічого не треба',
        source_spool_full: 'Немає місця, щоб зберегти файл для черги — звільніть місце на сервері',
  ...
  // Власна копія файла завдання в черзі (m173). Усі стани, відмови та
  // попередження «оригінал зникає» лежать тут, бо ті самі речення говорять і
  // діалог друку, і рядки черги, і підтвердження видалення — а друге
  // формулювання на кожному екрані і є те, як вони розходяться.
  queueSpool: {
    state: {
      ready: {
        label: 'Файл збережено',
        tip: 'Файл збережено для черги — завдання друкує власну копію й більше не потребує оригіналу.',
      },
      preparing: {
        label: 'Зберігаємо файл',
        tip: 'Зберігаємо копію файла для черги. Завдання чекає тут, доки копію не завершено.',
      },
      legacy: {
        label: 'Працює з оригіналом',
        tip: 'Це завдання не має збереженої копії свого файла, тож читає оригінал — тримайте його доступним до друку.',
      },
      broken: {
        label: 'Копію втрачено',
        tip: 'Збережена копія зникла або пошкоджена, тож завдання не надрукується. Додайте файл у чергу знову, а це завдання приберіть.',
      },
    },
    heldTip: 'Збережений файл лишається за цим завданням, поки ви не приберете його з черги.',
    saving: 'Зберігаємо файл для черги…',
    savingProgress: 'Зберігаємо файл для черги… {{current}} з {{total}}',
    // По одному реченню на кожну відмову, якою сервер може відповісти на
    // додавання. «Зайнято» — нормальний наслідок серії, а не поломка.
    reason: {
      source_copy_busy: 'Черга вже зберігає інші файли — спробуйте через мить.',
      source_spool_replaced: 'Відновлення з резервної копії саме замінює файли черги — спробуйте через мить.',
      source_unreadable: 'Не вдалося прочитати оригінальний файл. Перевірте, чи доступна його папка або спільний ресурс.',
      source_changed: 'Оригінальний файл змінився під час копіювання. Відкрийте його знову й додайте заново.',
      source_invalid: 'Оригінальний файл не є придатним 3MF — можливо, він обрізаний. Переріжте або завантажте його знову.',
      source_copy_timeout: 'Копіювання файла тривало надто довго й було зупинене. Перевірте зв\'язок зі сховищем файла.',
      source_spool_no_space: 'Бракує вільного місця на диску, щоб зберегти файл. Звільніть місце й спробуйте знову.',
      source_spool_write_failed: 'Не вдалося записати файл у теку даних BamDude. Перевірте диск і журнал сервера.',
      source_copy_failed: 'Не вдалося зберегти файл для черги.',
    },
    // Те, що оператор питає насправді: завдання створене чи ні? Кожне речення
    // самостійне — причину додаємо окремо для кожної групи принтерів, щоб
    // відповідь однієї машини не читалася як відповідь усіх.
    failure: {
      nothingQueued: 'До черги нічого не додано.',
      partial: 'Додано до черги: {{success}} з {{total}}. Ще {{failed}} не додано.',
      reasonFor: '{{printers}}: {{reason}}',
      deselected: 'Принтери, які вже взяли роботу, зняті з позначки, тож повторне «Додати» не дасть їм другого завдання.',
      quantityLeft: 'Кількість тепер просить {{count}} копій, яких ще бракує, а не всю партію знову.',
      uncertain: 'Невідомо, чи додано завдання — відповідь не надійшла. Список черги оновлено; перегляньте його, перш ніж додавати завдання знову.',
      uncertainPartial: 'Додано до черги: {{success}} з {{total}}. Щодо решти відповідь не надійшла, тож невідомо, чи їх додано. Список черги оновлено; перегляньте його, перш ніж додавати їх знову.',
    },
    // ⚠️ Рахуємо лише PENDING: саме їх скасовують обидва шляхи видалення.
    // Термінальний рядок — це історія: він і не друкується, і не скасовується.
    deleteNote: {
      checking: 'Перевіряємо, які роботи в черзі мають власну копію…',
      selfContained: 'Робіт у черзі з власною збереженою копією: {{count}}. Вони лишаються в черзі й надрукуються.',
      needsOriginal: 'Робіт у черзі, які досі читають ці файли: {{count}}. Їх буде скасовано разом із ними.',
      removeHint: 'Приберіть їх із черги самостійно, якщо вони більше не потрібні.',
      couldNotCheck: 'BamDude не зміг перевірити, які роботи в черзі використовують ці файли. Ті, що досі їх читають, буде скасовано разом із ними.',
      ownRowsOnly: 'Вам видно лише власні роботи в черзі, тож ці підрахунки можуть бути неповними.',
    },
  },
  ...
  settings: {
    ...
    usageAccuracy: {
      ...
      zeroPointArchive: 'Архівувати закриту котушку',
      zeroPointArchiveDesc: 'Після того як runout закрив котушку в нуль — перенести її в архів; лише коли принтер перейшов на резерв або в слот завантажили заміну. Типово вимкнено — лишіть так, якщо архівуєте порожні котушки самі',
    ...
    trackingModeSwitch: {
      title: 'Змінити облік філаменту?',
      toSpoolman: 'Відтепер філамент обліковуватиметься в Spoolman.',
      toBuiltIn: 'Відтепер філамент обліковуватиметься у вбудованому інвентарі.',
      checking: 'Перевіряю, що це змінить…',
      assignments_one: 'Буде знято {{count}} призначення слота — у новому режимі котушки призначаються слотам AMS заново.',
      assignments_few: 'Буде знято {{count}} призначення слотів — у новому режимі котушки призначаються слотам AMS заново.',
      assignments_many: 'Буде знято {{count}} призначень слотів — у новому режимі котушки призначаються слотам AMS заново.',
      assignments_other: 'Буде знято {{count}} призначень слотів — у новому режимі котушки призначаються слотам AMS заново.',
      noAssignments: 'Жодного призначення слота не буде знято.',
      printing: 'Зараз друкують: {{printers}}. Філамент цих друків не буде списано в жоден інвентар.',
      confirm: 'Змінити',
    },
    ...
    otherCameras: {
      title: 'Інші камери',
      description: 'Камери, які не належать принтеру — кімната, стелаж, сушарка. Вони показуються на стіні камер і кнопкою в заголовку свого розташування, і ніколи не підміняють власну камеру принтера.',
      add: 'Додати камеру',
      added: 'Камеру додано',
      name: 'Назва',
      namePlaceholder: 'Стелаж біля вікна',
      type: 'Тип',
      url: 'URL камери',
      device: 'Шлях до пристрою',
      snapshotUrlHelp: 'Необов\u2019язково. Посилання, яке віддає ОДИН кадр — його беруть замість того, щоб вичитувати «розігрівний» кадр із живого потоку. Корисно для go2rtc (/api/frame.jpeg) та IP-камер із власним snapshot-ендпоінтом. Залиште порожнім, щоб брати кадри з потоку вище.',
      location: 'Розташування',
      enabled: 'Показувати на стіні',
      testOk: 'Камера віддала кадр',
      testFailed: 'Кадру з цієї камери немає',
      deleteAria: 'Видалити камеру {{name}}',
      deleteTitle: 'Видалити цю камеру?',
      deleteMessage: '«{{name}}» більше не показуватиметься на стіні та у своєму розташуванні. Більше ніщо не зміниться.',
    },
    cameraLightAuto: 'Світло для камери',
    cameraLightAutoObico: 'І для детекції збоїв Obico',
    printerCameraLight: 'Світло для камери',
    printerCameraLightInherit: 'Як на фермі',
    printerCameraLightOff: 'Ні',
    ...
    tempAlarmSeparateFromBand: 'Сповіщення надсилає лише поріг тривоги — «добре» та «задовільно» тільки забарвлюють індикатор. Залиште порожнім, щоб спрацьовувати на порозі задовільного, як раніше. Поки AMS сушить або остигає після сушіння, тривога не надсилається.',
    tempAlarmMustBePositive: 'Поріг 0 або менший ігнорується — тривога спрацьовує на порозі задовільного.',
    ...
    dryingSchedules: {
      title: 'Розклади сушки',
      empty: 'Розкладів сушки ще немає',
      hint: 'Розклади створюються з поповера сушки на картці принтера. Час — час ферми ({{tz}}).',
      enabled: 'Увімкнено',
      paused: 'на паузі',
      columns: {
        printer: 'Принтер',
    ...
    staggerConcurrentPerGroup: 'Одночасних запусків на групу за замовчуванням',
    staggerConcurrentPerGroupDescription: 'Базовий ліміт принтерів, які гріються в одній групі. Окремий ліміт нижче може бути більшим або меншим; обирайте його відповідно до можливостей електромережі.',
    ...
    staggerGroupLimitHint: 'Порожнє поле успадковує базовий ліміт вище; число перевизначає його. Коли ввімкнено теги й локації, кожна вісь має свій ліміт, а їхній перетин бере менший.',
    ...
    // Надбавки прогнозу ETA (vault 60-specs/farm-forecast-v2-spec 7)
    etaForecastTitle: 'Прогноз ETA',
    etaForecastDescription: 'Надбавки, які прогноз ферми додає до часу друку. Стаггер-старт, прогрів і вимога підтвердити очистку столу читаються зі своїх налаштувань; сушка рахується лише поки блокує чергу.',
    etaUploadSeconds: 'Передача файла на друк (секунди)',
    etaUploadSecondsDescription: 'Додається перед кожним ще не запущеним друком — на передачу файла принтеру й очікування старту. Прогрів додається зверху, коли увімкнений.',
    etaPlateClearMinutes: 'Підтвердження очистки столу (хвилини)',
    etaPlateClearMinutesDescription: 'Додається після кожного друку на принтері, що вимагає підтвердити очистку столу. 0 = вважати стіл очищеним одразу.',
    ...
    preheatFilamentTargetsHint: 'BamDude обирає найвищу цільову температуру серед філаментів, які використовує друк, — котушка, що просто стоїть в AMS, не враховується. Друк, усі філаменти якого дають 0 (PLA, PETG, TPU, PVA), повністю пропускає прогрів і стартує одразу.',
    ...
    preheatTargetOverrideHelp: 'Значення 0 гріє стіл і виконує витримку без камери. Якщо лишити поле порожнім, друк, філаменти якого не потребують камери, повністю пропускає прогрів.',
    ...
    retention: {
      title: 'Зберігання історії',
      help: 'Скільки зберігати кожен вид записів. Старіші рядки прибираються раз на добу.',
      ...
      inbox: 'Сповіщення в інбоксі (днів)'
    },
    ...
    captureFinishPhotoDescription: 'Знімати фінальні фото та зображення для сповіщень. Під час друку BamDude може захоплювати кадри у фоні, щоб зберегти останній вигляд виробу. Вимкнено за замовчуванням. Таймлапс принтера не вмикається.',
    cameraLightAutoDescription: 'Перед будь-яким зверненням до камери — фото в Telegram, трансляція, стіна камер, фінальне фото, перевірка пластини — вмикати світло в камері, якщо воно вимкнене, і гасити після. Світло, що вже горіло, не чіпається; гаситься лише те, що вмикав BamDude. Типово вимкнено; кожен принтер може сказати «так» чи «ні» за себе у списку зовнішніх камер нижче.',
    cameraLightAutoObicoDescription: 'Obico дивиться в камеру кожні кілька секунд увесь друк, тож із цим перемикачем світло горітиме увесь друк. Типово вимкнено.',
  ...
  camera: {
    ...
    diagnose: {
      ...
      summary: {
        ...
        worker_unavailable: 'Воркер камер недоступний. Камерні перевірки можуть чекати; перевірте стан у розділі «Система» й журнали сервера.',
        camera_busy: 'Камера вже зайнята трансляцією або віртуальним принтером. Зупиніть цю сесію перед перевіркою.',
      ...
      meta: {
        ...
        port: 'Порт',
        profile: 'Профіль',
        frameSource: 'Джерело кадру',
        catalogResolution: 'Роздільність у каталозі',
      },
      captureSource: {
        fresh: 'Нове захоплення з камери',
        coalesced: 'Спільне одночасне захоплення',
      },
    },
  },
  ...
  slicerSettings: {
    ...
    fromFileOverridesPreset: 'перебиває пресет',
    fromFileOverridesPresetHint: 'Файл задає тут {{value}}, а вибраний пресет — {{preset}}. Позначте, лише якщо має перемогти файл.',
  ...
  slice: {
    ...
    designSettingsOverridesPreset: 'перебиває пресет',
    designSettingsOverridesPresetHint: "Висота шару — це і є вибраний пресет процесу, тож значення з файлу пропонується, але не позначене за замовчуванням. Позначте, лише якщо файл має перемогти ваш вибір.",
  ...
  copyQueue: {
    ...
    originalGone: 'скопіювати не можна, оригінальний файл зник',
    sourceUnavailable: 'скопіювати не можна, збережене джерело недоступне',
    noOtherPrinters: 'Інших принтерів {{model}} немає.',
    appendsHint: 'Копії стають у кінець кожної черги.',
    sourceHint: 'Збережені завдання використовують прийнятий файл; застарілі читають оригінал.',
    copy: 'Копіювати',
  },
  ...
  fileManager: {
    ...
    deleteFolderConfirm: 'Видалити цю папку? Файли всередині потраплять у корзину, звідки їх можна відновити. Роботи в черзі, які очікують і досі читають ці файли, буде скасовано, і відновлення файлів їх не поверне.',
  ...
  orders: {
    ...
    table: {
      ...
      printed: 'Надруковано',
      fromStock: 'Зі складу',
      printing: 'Друкується (друків)',
      queued: 'У черзі (завдань)',
      remaining: 'Лишилось забезпечити',
      progress: 'Забезпечено',
      due: 'Дедлайн',
      readyAt: 'Готово',
    ...
    card: {
      ...
      overdue: 'Прострочено',
      covered: 'Забезпечено',
      coverageSources: '{{printed}} надруковано · {{stock}} зі складу',
      remaining_one: 'Лишилось забезпечити {{count}}',
      remaining_few: 'Лишилось забезпечити {{count}}',
      remaining_many: 'Лишилось забезпечити {{count}}',
    ...
    figures: {
      ordered: 'Замовлено',
      printed: 'Надруковано',
      assemblyReady: 'Можна скомплектувати',
      remaining: 'Лишилось забезпечити',
      time: 'Час друку',
      grams: 'Філамент, г',
      cost: 'Собівартість',
      ...
      coverage: 'Забезпечено',
      coverageSources: '{{printed}} надруковано · {{stock}} зі складу',
      coverageHint: 'Надруковані комплекти та виділений склад; купівельні компоненти рахуються окремо.',
      printingPrints: 'Друкується (друків)',
      queuedJobs: 'У черзі (завдань)',
      readyAt: 'Готово ≈',
      readyIncomplete: 'Неповна оцінка',
      forecastStale: 'Оновіть після зміни плану',
      draftTotalsBelow: 'Див. змінений план нижче',
    ...
    filament: {
      ...
      short: 'бракує {{amount}}',
      shortAtLeast: 'бракує щонайменше {{amount}}',
      atLeast: 'щонайменше {{amount}}',
      weightUnknown: 'вага невідома',
      ...
      unattributedPrints_one: '{{count}} друк із невідомим філаментом',
      unattributedPrints_few: '{{count}} друки з невідомим філаментом',
      unattributedPrints_many: '{{count}} друків із невідомим філаментом',
      unattributedPrints_other: '{{count}} друків із невідомим філаментом',
    ...
    plan: {
      ...
      readyAt: 'готово ≈ {{when}}',
      forecastStale: 'Оцінка ферми належить попередньому плану. Надішліть цей draft у чергу або скасуйте зміни, щоб побачити її знову.',
      rebalance: {
  ...
  system: {
    ...
    version: 'Версія',
    uptime: 'Час роботи',
    bamdudeUptime: 'BamDude працює',
    bamdudeStarted: 'BamDude запущено',
    systemUptime: 'Система працює',
    systemStarted: 'Систему запущено',
    hostname: 'Ім\'я хоста',
    ...
    preview: {
      title: 'Локальний сервіс прев’ю',
      states: { ready: 'Доступний', starting: 'Запускається', recovering: 'Перезапускається', unavailable: 'Недоступний' },
      reasons: {
        not_started: 'Середовище прев’ю ще не запущене.',
        starting: 'Очікуємо запуску локального сервісу прев’ю.',
        stopped: 'Середовище прев’ю зупинене.',
        startup_failed: 'Не вдалося запустити локальний сервіс прев’ю.',
        recovery_required: 'Попереднє середовище брокера потребує перевірки власників перед відновленням.',
        broker_disconnected: 'Втрачено з’єднання з локальним брокером прев’ю.',
        worker_restarting: 'Воркер прев’ю автоматично перезапускається.',
        circuit_open: 'Повторні збої воркера; автоматичний перезапуск тимчасово відкладено.',
        ownership_uncertain: 'Завершення процесу прев’ю не підтверджене; перезапуск заборонено.',
      },
      scope: 'Генерує прев’ю моделей. Друк і наявні мініатюри не залежать від його доступності.',
      manualRecovery: 'Зупиніть BamDude й перевірте, що всі процеси прев’ю завершились, перш ніж виконувати інструкцію відновлення. Не видаляйте маркер середовища навмання.',
      checkLogs: 'Якщо стан не змінюється, перевірте журнали, залежності інсталяції, вільне місце та доступ до каталогу середовища.',
      error: 'Тип помилки',
      directory: 'Каталог середовища',
      guide: 'Діагностика та відновлення прев’ю',
    },
    cameraWorker: {
      title: 'Воркер камер',
      states: { ready: 'Доступний', starting: 'Запускається', recovering: 'Перезапускається', unavailable: 'Недоступний', stopped: 'Зупинений' },
      scope: 'Захоплення камер ізольоване. Друк і черги без залежності від камери працюють далі; камерні перевірки можуть чекати.',
      reason: 'Тип збою',
      nextRetry: 'Наступна спроба',
      restarts: 'Спроб перезапуску',
    },
    analysisWorker: {
      title: 'Воркер аналізу 3MF',
      states: { ready: 'Доступний', unavailable: 'Недоступний' },
      scope: 'Розраховує витрату філаменту поза головним циклом сервера. Якщо недоступний — нові прогнози призупинені, друк і черги працюють.',
      reason: 'Причина стану',
    },
  ...
  diagnostic: {
    ...
    check: {
      ...
      port_ftps: {
        ...
        warn_no_tls: 'Порт 990 відкритий, але файловий сервіс принтера не завершив TLS-рукостискання — він відхилив з\'єднання. Файли друку, обкладинки й таймлапси не вдасться ні забрати, ні надіслати, доки це не мине, а розблокування порту не допоможе. Найчастіше файловим сервісом саме користується інша програма (сторінка пристрою в слайсері, інша інтеграція): закрийте її й запустіть перевірку ще раз. Якщо так триває й без інших підключень — перезапустіть принтер.',
      },
      port_rtsps: {
      ...
      macos_local_network: {
        ...
        pass: 'macOS дозволяє BamDude доступ до локальної мережі.',
        warn_unsigned: 'Python, під яким працює BamDude, не має підпису коду, тож macOS нема до чого прив’язати дозвіл на локальну мережу і мовчки відкидає всі з’єднання з принтером - без помилки та без запиту. Підпишіть його, повторно запустивши інсталятор BamDude (install/install.sh), або вручну командою codesign --force --sign - "{{executable}}", і перезапустіть BamDude.',
        warn_permission: 'Якщо принтер увімкнений і доступний за цією адресою, відкрийте Системні параметри > Конфіденційність і безпека > Локальна мережа та переконайтеся, що Python, під яким працює BamDude, увімкнено. Інакше macOS мовчки відкидає локальні з’єднання, а оновлення Python може залишити старий дозвіл позаду.',
      },
      network_mode: {
        title: 'Мережевий режим контейнера',
        genericRuntime: 'контейнер',
        pass: 'Працює в {{runtime}} з host-мережею.',
        warn: 'BamDude працює в {{runtime}} з bridge-мережею. Виявлення принтерів і Віртуальний принтер потребують host-мережі - перестворіть контейнер у режимі host ("network_mode: host" у docker-compose, "--network=host" для Podman).',
        skip: 'Не працює в контейнері - не застосовується.',
        skip_unknown: 'BamDude працює в {{runtime}}, але його мережевий режим визначити не вдалося. Якщо виявлення принтерів чи Віртуальний принтер не працюють, перестворіть контейнер з host-мережею.',
        skip_system_container: 'BamDude працює в системному контейнері {{runtime}}, який стоїть у LAN як віртуальна машина - не застосовується.',
      },
      subnet: {
  ...
  systemHealth: {
    ...
    signature: {
      ...
      'ftp-tls-cleartext': {
        name: 'Принтер відповів на файловий порт без TLS',
        cause: 'Принтер відповів на захищеному порту передачі файлів (990) звичайним текстом замість TLS. Це не фаєрвол і не версія прошивки: так файловий сервер принтера відмовляє в з\'єднанні — найчастіше тому, що ним у цей момент користується інша програма (сторінка пристрою в слайсері, інша інтеграція), а принтер приймає приблизно одне файлове з\'єднання за раз.',
        fix: 'Закрийте інші програми, що переглядають або надсилають файли на цей принтер, і повторіть. Якщо повторюється, коли більше ніщо не підключене, — перезавантажте принтер. Рядок у лозі одразу після цієї помилки показує, що саме відповів принтер, — додайте його до звіту.',
      },
      'ftp-ssl-error': {
        name: 'Збій захищеного рукостискання передачі файлів',
        cause: 'Рукостискання TLS із сервером передачі файлів принтера не вдалося після того, як принтер почав говорити TLS.',
        fix: 'Перевірте, що між BamDude і принтером ніщо не перехоплює порт 990 (проксі чи пристрій безпеки), і повторіть. Рядок-приклад називає точну помилку TLS — додайте його до звіту.',
      },
  ...
  inventory: {
    ...
    csv: {
      ...
      exportHint: 'Експортує всі котушки за поточними фільтрами, а не лише цю сторінку. Підлаштуй під свою таблицю: європейська локаль хоче крапки з комою і десяткові коми; Excel на Windows потребує UTF-8 + BOM.',
    },
    title: 'Філамент',
  ...
  printModal: {
    ...
    ftsArrangementSaves: 'Рекомендований розклад філаменту заощадить близько {{time}}:',
    ftsArrangementMove: 'Філамент {{filament}} → AMS на вході IN-{{inlet}}',
    ftsSaveSeconds: '{{s}} с',
    ftsSaveMinutes: '{{m}} хв {{s}} с',
    ...
    runNext: 'Поставити наступним',
    runNextHint: 'Поставити завдання перед іншими завданнями, що очікують на вибраному принтері. Поточний друк не переривається.',
    hintAsap: 'Друк розпочнеться, коли принтер буде вільний і всі перевірки запуску пройдено.',
    hintScheduled: 'Друк може розпочатися у запланований час, коли принтер буде вільний і всі перевірки запуску пройдено. Інакше завдання чекатиме.',
  ...
  editArchive: {
    ...
    filamentUsed: 'Використано філаменту (г)',
    filamentUsedHelp: 'Лише для цього архіву — його читають статистика, вартість і показники замовлень; з котушок нічого не списується. Єдиний спосіб дати вагу друку, заархівованому без 3MF.',
  ...
  // Завантаження поточного логу й добові архіви під LogViewer на /system.
  logArchives: {
    title: 'Файли логів',
    subtitle: 'Завантажуйте поточний лог або добовий архів. Перезапуск не потрібен.',
    empty: 'Файлів логів поки немає.',
    current: 'Поточний',
    currentHint: 'Завантажити весь лог станом на початок копіювання. Запис логів триває.',
    filename: 'Файл',
    size: 'Розмір',
    modified: 'Змінено',
  ...
  notifications: {
    ...
    missingSpoolAssignmentDescription: 'Сповістити, коли друк починається без призначеної котушки у лотках, а також коли завершений друк не зміг списати свій філамент із котушки',
    ...
    scheduledDryingStarted: 'Сушку за розкладом розпочато',
    scheduledDryingStartedDescription: 'Заплановане вами сушіння AMS розпочалось',
    scheduledDryingCompleted: 'Сушку за розкладом завершено',
    scheduledDryingCompletedDescription: 'Заплановане вами сушіння відпрацювало до кінця',
    scheduledDryingFailed: 'Сушка за розкладом не відбулась',
    scheduledDryingFailedDescription:
      'Заплановане сушіння не запустилось — минуло вікно старту, юніт відмовив або не вміє сушити',
    ...
    center: {
      title: 'Сповіщення',
      tabs: { inbox: 'Вхідні', subscriptions: 'Підписки', email: 'Email' },
      severity: { info: 'Інфо', warning: 'Попередження', error: 'Помилка' },
      groups: {
        print: 'Друк',
        printer: 'Принтери',
        filament: 'Філамент',
      ...
      inbox: {
        ...
        emptyHint: 'Тут з’являтимуться події, на які ви підписані. Обрати їх можна на вкладці «Підписки».',
        ...
        markedRead: 'Позначено прочитаними: {{count}}',
        clear: 'Очистити',
        clearConfirmTitle: 'Очистити вхідні',
      ...
      subscriptions: {
        intro: 'Оберіть, які події потраплятимуть у ваші вхідні. За замовчуванням — лише попередження й помилки.',
        usingDefaults: 'Використовуються типові: попередження й помилки',
        custom: 'Власний вибір',
        reset: 'Скинути на типові',
        saveError: 'Не вдалося зберегти підписки.'
      },
      events: {
        print_start: 'Друк розпочато',
        print_complete: 'Друк завершено',
        ...
        print_stopped: 'Друк зупинено',
        print_paused: 'Друк призупинено',
        print_resumed: 'Друк відновлено',
        print_progress: 'Віхи прогресу друку',
        print_missing_spool_assignment: 'Відсутнє призначення котушки (на старті друку чи філамент не списано)',
        first_layer_complete: 'Перший шар готовий',
        bed_cooled: 'Стіл охолов',
        printer_error: 'Помилка принтера',
        printer_offline: 'Принтер офлайн',
        ai_failure_detection: 'AI виявив збій друку',
        plate_not_empty: 'Стіл не звільнено',
        maintenance_due: 'Час обслуговування',
        filament_runout: 'Філамент закінчився',
        filament_low: 'Філамент закінчується',
        filament_deficit: 'Філаменту не вистачить на завдання',
        ams_temperature_high: 'Висока температура в AMS',
        ams_ht_temperature_high: 'Висока температура в AMS-HT',
        ams_humidity_high: 'Висока вологість в AMS',
        ams_ht_humidity_high: 'Висока вологість в AMS-HT',
        ams_drying_suspended: 'Сушіння AMS призупинено',
        scheduled_drying_started: 'Сушку за розкладом розпочато',
        scheduled_drying_completed: 'Сушку за розкладом завершено',
        scheduled_drying_failed: 'Сушка за розкладом не відбулась',
        queue_job_failed: 'Завдання черги не вдалося',
        queue_job_skipped: 'Завдання черги пропущено',
        queue_job_waiting: 'Завдання черги чекає на вас',
        queue_job_added: 'Завдання додано в чергу',
        queue_job_started: 'Завдання черги запущено',
        queue_completed: 'Чергу виконано',
        printer_queue_completed: 'Чергу принтера виконано',
        stock_break_alert: 'Запас вичерпано',
        stock_reorder_alert: 'Запас нижче рівня дозамовлення',
        sensor_above_max: 'Датчик вище максимуму',
        sensor_below_min: 'Датчик нижче мінімуму',
        sensor_silent: 'Датчик замовк',
        sensor_back_in_range: 'Датчик повернувся в норму',
        sensor_speaking_again: 'Датчик знову звітує'
      }
    },
  ...
  failureDetection: {
    ...
    statusTitle: 'Статус',
    serviceRunning: 'Детекція активна',
  ...
  forecast: {
    ...
    reserved: 'Зайнято',
    reservedHint: 'Обіцяно активним замовленням — ще не надрукований план плюс те, що чекає в чергах',
    free: '{{grams}} г вільно',
    overCommitted: 'Обіцяно більше, ніж є',
    overCommittedDetail: 'замовленням бракує {{grams}} г понад те, що на полиці',
    unmatchedReserved: 'Зайнято під кольори, яких немає на полиці',
    reservedIncomplete: 'Частина ваги філаменту активних замовлень невідома. «Зайнято» й дати дозамовлення враховують лише відому частину.',
    actions: 'Дії',
    // Бейджі рівня темпу
    trend: 'Тренд',
    estimated: 'Оцінка',
