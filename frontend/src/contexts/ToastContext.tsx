...
// often runs to a couple of lines, and 3s is not long enough to finish reading
// one before it slides away. ⚠️ A missed error is gone for good: there is no
// notification history to go back to. Success/info stay short — they confirm
// something the user just did and are skimmed, not read.
//
// ⚠️ The background-dispatch toast keeps its own 3s and is NOT covered here:
// its timer measures "the summary has stopped changing", not reading time.
