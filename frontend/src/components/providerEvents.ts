...
const LABEL_KEYS: Record<string, string> = {
  ...
  on_scheduled_drying_started: 'scheduledDryingStarted',
  on_scheduled_drying_completed: 'scheduledDryingCompleted',
  on_scheduled_drying_failed: 'scheduledDryingFailed',
...
export const DESCRIPTION_KEYS: Record<string, string> = {
  ...
  on_scheduled_drying_started: 'scheduledDryingStartedDescription',
  on_scheduled_drying_completed: 'scheduledDryingCompletedDescription',
  on_scheduled_drying_failed: 'scheduledDryingFailedDescription',
