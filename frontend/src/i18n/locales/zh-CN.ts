export default {
  ...
  printers: {
    ...
    nozzleCount: '喷嘴数量',
    autoArchive: '自动归档',
    cleanupAfterPrint: '打印后清理',
    mqttConnectionTimeout: 'MQTT连接超时',
    status: {
      available: '可用',
      idle: '空闲',
      printing: '打印中',
    ...
    modal: {
      ...
      cleanupAfterPrintLabel: '打印后从SD卡删除文件（取消勾选则移至缓存）',
      mqttConnectionTimeoutLabel: 'MQTT连接超时',
      mqttConnectionTimeoutHint: '秒（0 = 禁用）',
  ...
  archives: {
    ...
    page: {
      ...
      reset: '重置',
      clear: '清除',
      matchAnyColor: '匹配任意选中颜色',
      matchAllColors: '匹配所有选中颜色',
      archivesAutoCreated: '打印完成后自动创建归档',
      unknownPrinter: '未知',
      slicedFor: '为 {{model}} 切片',
      noPrinter: '无打印机',
      exportAsCsv: '导出为 CSV',
  ...
  support: {
    title: '支持与故障排除',
    description: '启用调试日志记录以捕获详细信息，然后下载支持包以便在报告问题时共享。',
    debugLogging: '调试日志',
    debugLoggingActive: '调试日志记录已激活',
    debugLoggingEnabled: '正在捕获详细日志',
    debugLoggingDisabled: '正常日志级别',
    enableDebug: '启用',
    disableDebug: '禁用',
    manageLogs: '管理',
    supportBundle: '支持包',
    supportBundleDescription: '下载系统信息和日志（ZIP格式）',
    enableDebugFirst: '请先启用调试日志',
    instructions: '要报告问题：',
    step1: '启用调试日志',
    step2: '重现问题',
    step3: '下载支持包',
    step4: '将ZIP文件附加到问题报告',
    privacyTitle: '支持包中包含什么？',
    collected: '已收集：',
    collectItem1: '应用版本和调试模式',
    collectItem2: '操作系统、架构、Python版本',
    collectItem3: '数据库统计（仅计数）',
    collectItem4: '打印机型号和喷嘴数量',
    collectItem5: '非敏感设置（主题、格式）',
    collectItem6: '调试日志（已脱敏）',
    ...
    notItem6: '您的主机名或用户名',
    notItem7: 'IP地址',
    privacyNote: '日志中的电子邮件地址替换为[EMAIL]，打印机名称替换为[PRINTER]，序列号替换为[SERIAL]，IP地址替换为[IP]。',
  },
  ...
  system: {
    title: '系统信息',
    subtitle: '监控系统资源和数据库统计',
    failedToLoad: '无法加载系统信息',
    version: '版本',
    uptime: '运行时间',
    hostname: '主机名',
    application: '应用程序',
    database: '数据库',
    connectedPrinters: '已连接打印机',
    storage: '存储',
    memory: '内存',
    cpu: 'CPU',
    systemDetails: '系统详情',
    ...
    totalPrintTime: '总打印时间',
    totalFilament: '总耗材用量',
    ofTotal: '共 {{total}} 台打印机已连接',
    noPrintersConnected: '没有已连接的打印机',
    diskUsage: '磁盘使用',
    free: '可用',
    archiveStorage: '归档存储',
    databaseSize: '数据库大小',
    fileManagerStorage: '文件管理器',
    memoryUsage: '内存使用',
    available: '可用',
    cores: '核心',
    usage: '使用率',
  ...
  virtualPrinter: {
    ...
    howItWorks: {
      ...
      step2: '在归档、审核、队列和文件管理器模式下，使用切片软件中的"发送"按钮将 3MF 文件上传到 Bambuddy。切片软件会显示"打印成功"— 文件已存储，未打印。',
  ...
  logViewer: {
    title: '应用日志',
    subtitle: '查看和过滤应用日志',
    liveStreaming: '实时推送 - {{count}} 条记录',
    live: '实时',
    stop: '停止',
    start: '开始',
    clear: '清除',
    autoScroll: '自动滚动',
    searchPlaceholder: '搜索消息或日志记录器名称...',
    all: '全部',
    noLogEntries: '未找到日志条目',
    logFileEmpty: '日志文件可能为空或已清除',
    autoRefreshing: '每2秒自动刷新',
    clickStartHint: '点击"开始"启用实时日志推送',
  },
