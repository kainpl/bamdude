...
EVENT_LABELS = {
    ...
    "scheduled_drying_started": "Scheduled drying started",
    "scheduled_drying_completed": "Scheduled drying finished",
    "scheduled_drying_failed": "Scheduled drying did not happen",
