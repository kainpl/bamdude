    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      ...
      <div className="bg-bambu-dark-secondary rounded-lg w-full max-w-md border border-bambu-dark-tertiary flex flex-col max-h-[calc(100vh-2rem)]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
          ...
          {/* Sticky action footer — stays visible regardless of scroll position
              so Save/Cancel are always reachable on short screens (#1642).
              Buttons stay inside <form> for type="submit". */}
  ...
  return (
    <div className="p-4 md:p-6 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div>
            <h1 className="text-2xl font-bold text-white flex items-center gap-3"><FolderKanban className="w-6 h-6 text-bambu-green" />{t('projects.title')}</h1>
