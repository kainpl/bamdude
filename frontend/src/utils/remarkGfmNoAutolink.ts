/**
 * GFM markdown support without autolink literals (upstream #2971, audit D12).
 *
 ...
 *
 *     a lookbehind for start / whitespace / punctuation / symbol, then
 *     ([-.\w+]+)@([-\w]+(?:\.[-\w]+)+) with the gu flags
 *
 * `(?` + `<=` opens a lookbehind assertion. Safari shipped lookbehind in **16.4**; it
