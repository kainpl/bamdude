export default {
  ...
  printers: {
    ...
    cleanupAfterPrint: 'Pulizia dopo la stampa',
    mqttConnectionTimeout: 'Timeout connessione MQTT',
    status: {
    ...
    modal: {
      ...
      cleanupAfterPrintLabel: 'Elimina i file dalla scheda SD dopo la stampa (deseleziona per spostare nella cache)',
      mqttConnectionTimeoutLabel: 'Timeout connessione MQTT',
      mqttConnectionTimeoutHint: 'secondi (0 = disabilitato)',
  ...
  archives: {
    ...
    page: {
      collection: {
        all: 'Tutto',
        recent: 'Ultime 24 ore',
        thisWeek: 'Questa settimana',
        thisMonth: 'Questo mese',
        favorites: 'Preferiti',
        failed: 'Stampe fallite',
      ...
      slicedGcode: 'Affettato (GCODE)',
      sourceOnly: 'Solo sorgente',
      allTags: 'Tutti i tag',
      favorites: 'Preferiti',
      hideFailed: 'Nascondi falliti',
      colors: 'Colori:',
      reset: 'Reimposta',
      clear: 'Cancella',
      matchAnyColor: 'Corrisponde a QUALSIASI colore selezionato',
      matchAllColors: 'Corrisponde a TUTTI i colori selezionati',
      archivesAutoCreated: 'Gli archivi vengono creati automaticamente al termine delle stampe',
      unknownPrinter: 'Sconosciuto',
      slicedFor: 'Affettato per {{model}}',
      noPrinter: 'Nessuna stampante',
      exportAsCsv: 'Esporta come CSV',
      exportAsExcel: 'Esporta come Excel',
      compare: 'Confronta ({{count}})',
      select: 'Seleziona',
      upload3mf: 'Carica 3MF',
    },
    calendar: {
      totalPrints: 'Stampe (30 giorni)',
      successful: 'Riuscite',
      failed: 'Fallite',
  ...
  // Support/Debug
  support: {
    title: 'Supporto e Risoluzione problemi',
    description: 'Abilita il log di debug per acquisire informazioni dettagliate, poi scarica un pacchetto di supporto da condividere.',
    debugLogging: 'Log di debug',
    debugLoggingActive: 'Log debug attivo',
    debugLoggingEnabled: 'Acquisizione log dettagliati',
    debugLoggingDisabled: 'Livello di log normale',
    enableDebug: 'Abilita',
    disableDebug: 'Disabilita',
    manageLogs: 'Gestisci',
    supportBundle: 'Pacchetto di supporto',
    supportBundleDescription: 'Scarica info di sistema e log come file ZIP',
    enableDebugFirst: 'Abilita prima il log di debug',
    instructions: 'Per segnalare un problema:',
    step1: 'Abilitare il log di debug',
    step2: 'Riprodurre il problema',
    step3: 'Scaricare il pacchetto di supporto',
    step4: 'Allegare il file ZIP alla segnalazione',
    privacyTitle: 'Cosa contiene il pacchetto di supporto?',
    collected: 'Raccolto:',
    collectItem1: 'Versione app e modalità debug',
    collectItem2: 'OS, architettura, versione Python',
    collectItem3: 'Statistiche database (solo conteggi)',
    collectItem4: 'Modelli stampante e numero ugelli',
    collectItem5: 'Impostazioni non sensibili (temi, formati)',
    collectItem6: 'Log di debug (sanitizzati)',
    ...
    notCollected: 'NON raccolto:',
    notItem1: 'Nomi e numeri di serie delle stampanti',
    notItem2: 'Codici di accesso e password',
    notItem3: 'Indirizzi email',
    notItem4: 'Chiavi API e token',
    notItem5: 'URL dei webhook',
    notItem6: 'Il tuo hostname o nome utente',
    notItem7: 'Indirizzi IP',
    privacyNote: 'Gli indirizzi email nei log sono sostituiti con [EMAIL], i nomi delle stampanti con [PRINTER], i numeri di serie con [SERIAL] e gli indirizzi IP con [IP].',
  },
  ...
  system: {
    ...
    subtitle: 'Monitora risorse di sistema e statistiche del database',
    failedToLoad: 'Impossibile caricare le informazioni di sistema',
    version: 'Versione',
    uptime: 'Tempo di attività',
    hostname: 'Hostname',
    application: 'Applicazione',
    database: 'Database',
    connectedPrinters: 'Stampanti connesse',
    storage: 'Archiviazione',
    memory: 'Memoria',
    cpu: 'CPU',
    systemDetails: 'Dettagli di sistema',
    totalArchives: 'Archivi totali',
    ...
    filaments: 'Filamenti',
    projects: 'Progetti',
    smartPlugs: 'Prese intelligenti',
    totalPrintTime: 'Tempo di stampa totale',
    totalFilament: 'Filamento totale utilizzato',
    ofTotal: 'di {{total}} stampanti connesse',
    noPrintersConnected: 'Nessuna stampante connessa',
    diskUsage: 'Utilizzo disco',
    free: 'libero',
    archiveStorage: 'Archiviazione archivi',
    databaseSize: 'Dimensione database',
    fileManagerStorage: 'Gestore file',
    ...
    enableDebug: 'Abilita log di debug',
    disableDebug: 'Disabilita log di debug',
  ...
  virtualPrinter: {
    ...
    mode: {
      ...
      fileManager: 'Gestore file',
      fileManagerDesc: 'Salva direttamente nel gestore file',
      proxy: 'Proxy',
    ...
    howItWorks: {
      ...
      step2: 'In modalità Archivio, Revisione, Coda e Gestore file, usa il pulsante "Invia" nel tuo slicer per caricare file 3MF su Bambuddy. Lo slicer mostrerà "Stampa riuscita" — il file viene salvato, non stampato.',
  ...
  logViewer: {
    ...
    subtitle: 'Visualizza e filtra i log dell\'applicazione',
    liveStreaming: 'Streaming live - {{count}} voci',
    live: 'Live',
    stop: 'Ferma',
    start: 'Avvia',
    clear: 'Cancella',
    autoScroll: 'Scorrimento auto',
    searchPlaceholder: 'Cerca per messaggio o nome logger...',
    all: 'Tutti',
    noLogEntries: 'Nessuna voce di log trovata',
    logFileEmpty: 'Il file di log potrebbe essere vuoto o cancellato',
    autoRefreshing: 'Aggiornamento automatico ogni 2 secondi',
    clickStartHint: 'Clicca Avvia per abilitare lo streaming live dei log',
  },
