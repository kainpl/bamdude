export default {
  ...
  printModal: {
    ...
    ftsSameInletHint: 'Усі філаменти цього друку підключені до входу IN-{{inlet}} перемикача тракту філаменту. Зміна між філаментами на одному вході повільніша — перемістіть один в AMS на іншому вході, щоб пришвидшити.',
