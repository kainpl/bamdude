export default {
  ...
  printers: {
    ...
    cleanupAfterPrint: 'Bereinigung nach Druck',
    mqttConnectionTimeout: 'MQTT-Verbindungs-Timeout',
    status: {
      available: 'Verfügbar',
      idle: 'Bereit',
      printing: 'Druckt',
    ...
    modal: {
      ...
      cleanupAfterPrintLabel: 'Druckdateien nach dem Druck von der SD-Karte löschen (deaktivieren um in Cache zu verschieben)',
      mqttConnectionTimeoutLabel: 'MQTT-Verbindungs-Timeout',
      mqttConnectionTimeoutHint: 'Sekunden (0 = deaktiviert)',
  ...
  archives: {
    ...
    page: {
      ...
      reset: 'Zurücksetzen',
      clear: 'Löschen',
      matchAnyColor: 'EINE der gewählten Farben',
      matchAllColors: 'ALLE gewählten Farben',
      archivesAutoCreated: 'Archive werden automatisch nach Abschluss eines Drucks erstellt',
      unknownPrinter: 'Unbekannt',
      slicedFor: 'Gesliced für {{model}}',
    ...
    calendar: {
      totalPrints: 'Drucke (30 Tage)',
      successful: 'Erfolgreich',
      failed: 'Fehlgeschlagen',
      noPrints: 'Keine Drucke an diesem Tag',
      selectDay: 'Wählen Sie einen Tag, um Drucke anzuzeigen',
    },
    list: {
      name: 'Name',
      printer: 'Drucker',
  ...
  support: {
    ...
    description: 'Aktivieren Sie das Debug-Logging, um detaillierte Informationen zu erfassen, und laden Sie dann ein Support-Paket herunter.',
    debugLogging: 'Debug-Protokollierung',
    debugLoggingActive: 'Debug-Protokollierung ist aktiv',
    debugLoggingEnabled: 'Detaillierte Protokolle werden erfasst',
    debugLoggingDisabled: 'Normales Protokollierungsniveau',
    enableDebug: 'Aktivieren',
    disableDebug: 'Deaktivieren',
    manageLogs: 'Verwalten',
    supportBundle: 'Support-Paket',
    supportBundleDescription: 'Systeminformationen und Protokolle als ZIP herunterladen',
    enableDebugFirst: 'Zuerst Debug-Logging aktivieren',
    instructions: 'Um ein Problem zu melden:',
    step1: 'Debug-Logging aktivieren',
    step2: 'Das Problem reproduzieren',
    step3: 'Support-Paket herunterladen',
    step4: 'ZIP-Datei an den Fehlerbericht anhängen',
    privacyTitle: 'Was enthält das Support-Paket?',
    collected: 'Erfasst:',
    collectItem1: 'App-Version und Debug-Modus',
    collectItem2: 'OS, Architektur, Python-Version',
    collectItem3: 'Datenbankstatistiken (nur Anzahlen)',
    collectItem4: 'Druckermodelle und Düsenanzahl',
    collectItem5: 'Nicht-sensible Einstellungen (Themes, Formate)',
    collectItem6: 'Debug-Protokolle (bereinigt)',
    ...
    notCollected: 'NICHT erfasst:',
    notItem1: 'Druckernamen und Seriennummern',
    notItem2: 'Zugangscodes und Passwörter',
    notItem3: 'E-Mail-Adressen',
    notItem4: 'API-Schlüssel und Tokens',
    notItem5: 'Webhook-URLs',
    notItem6: 'Ihr Hostname oder Benutzername',
    notItem7: 'IP-Adressen',
    privacyNote: 'E-Mail-Adressen in Protokollen werden durch [EMAIL] ersetzt, Druckernamen durch [PRINTER], Seriennummern durch [SERIAL] und IP-Adressen durch [IP].',
  },
  ...
  system: {
    ...
    subtitle: 'Systemressourcen und Datenbankstatistiken überwachen',
    failedToLoad: 'Systeminformationen konnten nicht geladen werden',
    version: 'Version',
    uptime: 'Betriebszeit',
    hostname: 'Hostname',
    ...
    totalPrintTime: 'Gesamte Druckzeit',
    totalFilament: 'Gesamtes Filament verbraucht',
    ofTotal: 'von {{total}} Druckern verbunden',
    ...
    fileManagerStorage: 'Dateimanager',
  ...
  virtualPrinter: {
    ...
    mode: {
      ...
      fileManager: 'Dateimanager',
      fileManagerDesc: 'Direkt im Dateimanager speichern',
      proxy: 'Proxy',
    ...
    howItWorks: {
      ...
      step2: 'Im Archiv-, Überprüfungs-, Warteschlangen- und Dateimanager-Modus verwende die "Senden"-Funktion im Slicer, um 3MF-Dateien an Bambuddy zu senden. Der Slicer zeigt "Druck erfolgreich" — die Datei wird gespeichert, nicht gedruckt.',
  ...
  logViewer: {
    ...
    subtitle: 'Anwendungsprotokolle anzeigen und filtern',
    ...
    logFileEmpty: 'Protokolldatei ist möglicherweise leer oder gelöscht',
    autoRefreshing: 'Automatische Aktualisierung alle 2 Sekunden',
    clickStartHint: 'Klicken Sie auf Start, um Live-Protokollierung zu aktivieren',
  },
