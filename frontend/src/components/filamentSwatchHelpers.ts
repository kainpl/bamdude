/* Enhanced filament-colour rendering helpers (#1154 + follow-up #1154 fixes).
 *
 ...
 *  by the spool form's effect dropdown so the form, helpers, and tests stay
 *  in lockstep. Each value pairs with an i18n key under
 *  ``inventory.spoolForm.effects.<key>`` (kebab → camel: `dualColor` /
 *  `triColor`). */
export const FILAMENT_EFFECT_OPTIONS: ReadonlyArray<{
  value: '' | FilamentEffect;
  labelKey: string;
}> = [
  { value: '', labelKey: 'inventory.spoolForm.effectNone' },
  // Surface effects
  { value: 'sparkle', labelKey: 'inventory.spoolForm.effects.sparkle' },
  { value: 'wood', labelKey: 'inventory.spoolForm.effects.wood' },
  { value: 'marble', labelKey: 'inventory.spoolForm.effects.marble' },
  { value: 'glow', labelKey: 'inventory.spoolForm.effects.glow' },
  { value: 'matte', labelKey: 'inventory.spoolForm.effects.matte' },
  // Sheen / finish
  { value: 'silk', labelKey: 'inventory.spoolForm.effects.silk' },
  { value: 'galaxy', labelKey: 'inventory.spoolForm.effects.galaxy' },
  { value: 'rainbow', labelKey: 'inventory.spoolForm.effects.rainbow' },
  { value: 'metal', labelKey: 'inventory.spoolForm.effects.metal' },
  { value: 'translucent', labelKey: 'inventory.spoolForm.effects.translucent' },
  // Multi-colour structures
  { value: 'gradient', labelKey: 'inventory.spoolForm.effects.gradient' },
  { value: 'dual-color', labelKey: 'inventory.spoolForm.effects.dualColor' },
  { value: 'tri-color', labelKey: 'inventory.spoolForm.effects.triColor' },
  { value: 'multicolor', labelKey: 'inventory.spoolForm.effects.multicolor' },
];
