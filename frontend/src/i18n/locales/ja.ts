export default {
  ...
  printers: {
    ...
    nozzleCount: 'ノズル数',
    autoArchive: '自動アーカイブ',
    cleanupAfterPrint: '印刷後のクリーンアップ',
    mqttConnectionTimeout: 'MQTT接続タイムアウト',
    status: {
      available: '利用可能',
      idle: '待機中',
      printing: '印刷中',
    ...
    modal: {
      ...
      cleanupAfterPrintLabel: '印刷後にSDカードからファイルを削除（キャッシュに移動するにはチェックを外す）',
      mqttConnectionTimeoutLabel: 'MQTT接続タイムアウト',
      mqttConnectionTimeoutHint: '秒（0 = 無効）',
  ...
  archives: {
    ...
    page: {
      ...
      reset: 'リセット',
      clear: 'クリア',
      matchAnyColor: '選択した色のいずれかに一致',
      matchAllColors: '選択したすべての色に一致',
      archivesAutoCreated: 'アーカイブは印刷完了時に自動的に作成されます',
      unknownPrinter: '不明',
      slicedFor: '{{model}} 用にスライス',
      noPrinter: 'プリンターなし',
    ...
    calendar: {
      ...
      successful: '成功',
      failed: '失敗',
      noPrints: 'この日の印刷はありません',
      selectDay: '日付を選択して印刷を表示',
    },
    list: {
      name: '名前',
      printer: 'プリンター',
  ...
  support: {
    ...
    description: 'デバッグログを有効にして詳細情報をキャプチャし、サポートバンドルをダウンロードして共有してください。',
    debugLogging: 'デバッグログ',
    debugLoggingActive: 'デバッグログが有効です',
    debugLoggingEnabled: '詳細ログをキャプチャ中',
    debugLoggingDisabled: '通常のログレベル',
    enableDebug: '有効化',
    disableDebug: '無効化',
    manageLogs: '管理',
    supportBundle: 'サポートバンドル',
    supportBundleDescription: 'システム情報とログをZIPでダウンロード',
    enableDebugFirst: '先にデバッグログを有効にしてください',
    instructions: '問題を報告するには：',
    step1: 'デバッグログを有効にする',
    step2: '問題を再現する',
    step3: 'サポートバンドルをダウンロードする',
    step4: 'ZIPファイルをレポートに添付する',
    privacyTitle: 'サポートバンドルの内容は？',
    collected: '収集内容：',
    collectItem1: 'アプリバージョンとデバッグモード',
    collectItem2: 'OS、アーキテクチャ、Pythonバージョン',
    collectItem3: 'データベース統計（件数のみ）',
    collectItem4: 'プリンターモデルとノズル数',
    collectItem5: '非機密設定（テーマ、フォーマット）',
    collectItem6: 'デバッグログ（サニタイズ済み）',
    ...
    notCollected: '収集しない内容：',
    notItem1: 'プリンター名とシリアル番号',
    notItem2: 'アクセスコードとパスワード',
    notItem3: 'メールアドレス',
    notItem4: 'APIキーとトークン',
    notItem5: 'Webhook URL',
    notItem6: 'ホスト名またはユーザー名',
    notItem7: 'IPアドレス',
    privacyNote: 'ログ内のメールアドレスは[EMAIL]に、プリンター名は[PRINTER]に、シリアル番号は[SERIAL]に、IPアドレスは[IP]に置換されます。',
  },
  ...
  system: {
    title: 'システム情報',
    subtitle: 'システムリソースとデータベース統計を監視',
    failedToLoad: 'システム情報の読み込みに失敗しました',
    version: 'バージョン',
    uptime: '稼働時間',
    hostname: 'ホスト名',
    application: 'アプリケーション',
    database: 'データベース',
    connectedPrinters: '接続済みプリンター',
    storage: 'ストレージ',
    memory: 'メモリ',
    cpu: 'CPU',
    systemDetails: 'システム詳細',
    totalArchives: 'アーカイブ総数',
    completed: '完了',
    failed: '失敗',
    printing: '印刷中',
    printers: 'プリンター',
    ...
    projects: 'プロジェクト',
    smartPlugs: 'スマートプラグ',
    totalPrintTime: '合計印刷時間',
    totalFilament: '合計フィラメント使用量',
    ofTotal: '{{total}}台中接続済み',
    noPrintersConnected: '接続済みプリンターなし',
    diskUsage: 'ディスク使用量',
    free: '空き',
    archiveStorage: 'アーカイブストレージ',
    databaseSize: 'データベースサイズ',
    fileManagerStorage: 'ファイルマネージャー',
    memoryUsage: 'メモリ使用量',
    available: '利用可能',
    cores: 'コア',
    usage: '使用率',
  ...
  virtualPrinter: {
    ...
    mode: {
      ...
      fileManager: 'ファイルマネージャー',
      fileManagerDesc: 'ファイルマネージャーに直接保存',
      proxy: 'プロキシ',
    ...
    howItWorks: {
      ...
      step2: 'アーカイブ、レビュー、キュー、ファイルマネージャーモードでは、スライサーの「送信」ボタンを使用して3MFファイルをBambuddyにアップロードします。スライサーは「印刷成功」と表示しますが、ファイルは保存され、印刷はされません。',
  ...
  logViewer: {
    title: 'アプリケーションログ',
    subtitle: 'アプリケーションログの表示とフィルタリング',
    ...
    logFileEmpty: 'ログファイルが空か、クリアされた可能性があります',
    autoRefreshing: '2秒ごとに自動更新',
    clickStartHint: '開始をクリックしてライブログストリーミングを有効にする',
  },
