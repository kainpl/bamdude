...
def authenticate_ldap_user(config: LDAPConfig, username: str, password: str) -> LDAPUserInfo | None:
    ...
    try:
        ...
        # Standard Unix semantics treat this as full group membership, so we resolve
        # it to a group DN alongside the memberUid results.
        ...
        # LDAP DNs are case-insensitive by spec.
