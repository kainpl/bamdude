...
const FORECAST = { project_id: 42, now_eta: null, now_seconds: null, after_eta: null, after_seconds: null, machine_seconds: 0, unknown_prints: 0, unroutable_prints: 0, eta_complete: true, ahead_count: 0, assumptions: [], lines: [] };
const ORDER = { id: 42, name: 'Flasks', status: 'active', lines: [], figures: { ordered: 0, printed: 0, covered_units: 0, complete: 0, remaining: 0, total_time_seconds: 0, total_filament_grams: 0, total_cost: 0, defective: 0, margin: null, progress: 0, other_prints_count: 0, all_printed: false, from_stock_units: 0, bankable_surplus: 0, prints_in_progress: 0, prints_queued: 0 }, procurement: [], other_archive_ids: [], customer_id: null, customer_name: null, description: null, color: null, notes: null, attachments: null, tags: null, due_date: null, priority: 'normal', price: null, url: null, cover_image_filename: null, created_at: '2026-09-06T10:00:00', updated_at: '2026-09-06T10:00:00' };
