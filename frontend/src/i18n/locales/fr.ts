export default {
  ...
  printers: {
    ...
    cleanupAfterPrint: 'Nettoyage après impression',
    mqttConnectionTimeout: 'Délai de connexion MQTT',
    status: {
    ...
    modal: {
      ...
      cleanupAfterPrintLabel: 'Supprimer les fichiers de la carte SD après impression (décocher pour déplacer vers le cache)',
      mqttConnectionTimeoutLabel: 'Délai de connexion MQTT',
      mqttConnectionTimeoutHint: 'secondes (0 = désactivé)',
  ...
  archives: {
    ...
    page: {
      ...
      slicedGcode: 'Découpé (GCODE)',
      sourceOnly: 'Source uniquement',
      allTags: 'Tous les tags',
      favorites: 'Favoris',
      hideFailed: 'Masquer les échecs',
      colors: 'Couleurs :',
      reset: 'Réinitialiser',
      clear: 'Effacer',
      matchAnyColor: 'Correspondre à N\'IMPORTE QUELLE couleur sélectionnée',
      matchAllColors: 'Correspondre à TOUTES les couleurs sélectionnées',
      archivesAutoCreated: 'Les archives sont créées automatiquement à la fin des impressions',
      unknownPrinter: 'Inconnu',
      slicedFor: 'Découpé pour {{model}}',
      noPrinter: 'Pas d\'imprimante',
      exportAsCsv: 'Exporter en CSV',
      exportAsExcel: 'Exporter en Excel',
      compare: 'Comparer ({{count}})',
      select: 'Sélectionner',
      upload3mf: 'Télécharger 3MF',
    },
    calendar: {
      totalPrints: 'Impressions (30 jours)',
      successful: 'Réussies',
      failed: 'Échouées',
  ...
  support: {
    ...
    description: 'Activez la journalisation de débogage pour capturer des informations détaillées, puis téléchargez un bundle de support.',
    debugLogging: 'Journalisation de débogage',
    debugLoggingActive: 'Débogage actif',
    debugLoggingEnabled: 'Capture des journaux détaillés',
    debugLoggingDisabled: 'Niveau de journalisation normal',
    enableDebug: 'Activer',
    disableDebug: 'Désactiver',
    manageLogs: 'Gérer',
    supportBundle: 'Bundle de support',
    supportBundleDescription: 'Télécharger les infos système et journaux en ZIP',
    enableDebugFirst: 'Activez d\'abord la journalisation de débogage',
    instructions: 'Pour signaler un problème :',
    step1: 'Activer la journalisation de débogage',
    step2: 'Reproduire le problème',
    step3: 'Télécharger le bundle de support',
    step4: 'Joindre le fichier ZIP à votre rapport',
    privacyTitle: 'Que contient le bundle de support ?',
    collected: 'Collecté :',
    collectItem1: 'Version de l\'app et mode débogage',
    collectItem2: 'OS, architecture, version Python',
    collectItem3: 'Statistiques de la base de données (comptages uniquement)',
    collectItem4: 'Modèles d\'imprimantes et nombre de buses',
    collectItem5: 'Paramètres non sensibles (thèmes, formats)',
    collectItem6: 'Journaux de débogage (nettoyés)',
    ...
    notItem1: 'Noms et numéros de série des imprimantes',
    notItem2: 'Codes d\'accès et mots de passe',
    notItem3: 'Adresses e-mail',
    notItem4: 'Clés API et tokens',
    notItem5: 'URLs de webhook',
    notItem6: 'Votre nom d\'hôte ou nom d\'utilisateur',
    notItem7: 'Adresses IP',
    privacyNote: 'Les adresses e-mail dans les journaux sont remplacées par [EMAIL], les noms d\'imprimantes par [PRINTER], les numéros de série par [SERIAL] et les adresses IP par [IP].',
  },
  ...
  system: {
    ...
    subtitle: 'Surveiller les ressources système et les statistiques de la base de données',
    failedToLoad: 'Impossible de charger les informations système',
    version: 'Version',
    uptime: 'Temps de fonctionnement',
    hostname: 'Nom d\'hôte',
    application: 'Application',
    database: 'Base de données',
    connectedPrinters: 'Imprimantes connectées',
    storage: 'Stockage',
    memory: 'Mémoire',
    cpu: 'CPU',
    ...
    smartPlugs: 'Prises connectées',
    totalPrintTime: 'Temps d\'impression total',
    totalFilament: 'Filament total utilisé',
    ofTotal: 'sur {{total}} imprimantes connectées',
    ...
    fileManagerStorage: 'Gestionnaire de fichiers',
    ...
    enableDebug: 'Activer la journalisation de débogage',
    disableDebug: 'Désactiver la journalisation de débogage',
  ...
  virtualPrinter: {
    ...
    mode: {
      ...
      fileManager: 'Gestionnaire de fichiers',
      fileManagerDesc: 'Enregistrer directement dans le gestionnaire de fichiers',
      proxy: 'Proxy',
    ...
    howItWorks: {
      ...
      step2: 'En mode Archive, Revue, File d\'attente et Gestionnaire de fichiers, utilisez le bouton "Envoyer" dans votre slicer pour envoyer des fichiers 3MF à Bambuddy. Le slicer affichera "Impression réussie" — le fichier est stocké, pas imprimé.',
  ...
  logViewer: {
    ...
    subtitle: 'Afficher et filtrer les journaux de l\'application',
    liveStreaming: 'Streaming en direct - {{count}} entrées',
    live: 'En direct',
    stop: 'Arrêter',
    start: 'Démarrer',
    clear: 'Effacer',
    autoScroll: 'Défilement auto',
    searchPlaceholder: 'Rechercher par message ou nom de logger...',
    all: 'Tous',
    noLogEntries: 'Aucune entrée de journal trouvée',
    logFileEmpty: 'Le fichier journal est peut-être vide ou effacé',
    autoRefreshing: 'Actualisation automatique toutes les 2 secondes',
    clickStartHint: 'Cliquez sur Démarrer pour activer le streaming en direct',
  },
