export default {
  ...
  bugReport: {
    ...
    diagnosticHeading: 'Можливо, виявлено проблему налаштування',
    diagnosticIntro: 'У принтера є проблема з підключенням, яка може спричиняти вашу проблему. Перегляньте виправлення нижче — його усунення може вирішити проблему без звіту про баг. Ви все одно можете надіслати звіт нижче.',
